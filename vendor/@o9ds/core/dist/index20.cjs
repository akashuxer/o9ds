...
const TIP_ID = "o9ds-tip";
const OVERLAY_ID = "o9ds-tooltip-overlay";
...
function createTooltipManager(deps) {
  ...
  function ensureElement() {
    ...
    _txtEl.className = "o9ds-tip__txt";
    _el.appendChild(_txtEl);
    _shortcutEl = document.createElement("span");
    _shortcutEl.className = "o9ds-tip__shortcut";
