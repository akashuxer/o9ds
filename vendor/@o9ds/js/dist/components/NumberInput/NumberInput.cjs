...
const _O9NumberInput = class _O9NumberInput {
  ...
  _render() {
    ...
    if (!isReadOnly) {
      ...
      this._incrementBtnInstance = IconButton.O9IconButton.initialize(this._incrementBtn, {
        size: "sm",
        variant: "tertiary",
        icon: "angle-up",
      ...
      this._decrementBtnInstance = IconButton.O9IconButton.initialize(this._decrementBtn, {
        size: "sm",
        variant: "tertiary",
        icon: "angle-down",
        isDisabled: isDisabled || isLoading
  ...
  setError(message) {
    ...
    if (this._options.isInlineError) {
      if (!this._errIcoEl && this._actionsEl) {
        this._errIcoEl = utils.createInlineErrorIcon({ tooltip: msg });
        this._errIcoEl.classList.add("o9ds-number-input__err-ico");
        this._errIcoConnector = core.connectTooltip(core.tooltipManager, {
          anchor: this._errIcoEl,
          content: msg
...
exports.O9NumberInput = O9NumberInput;
