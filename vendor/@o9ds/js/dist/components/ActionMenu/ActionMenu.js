import { filterGroups, filterItems, createArrowNav, overlayHub, computePosition, createPositionWatcher, enter, createFocusTrap, exit } from "@o9ds/core";
import { O9IconButton } from "../IconButton/IconButton.js";
import { O9Popover } from "../Popover/Popover.js";
...
const _O9ActionMenu = class _O9ActionMenu {
    ...
    if (hasTrailing) {
      ...
      if ((_b = item.trailingActions) == null ? void 0 : _b.length) {
        ...
        for (const action of item.trailingActions) {
          ...
          const inst = O9IconButton.initialize(btnEl, {
            variant: "tertiary",
            size: "sm",
            icon: action.icon,
  ...
  _openInlinePanel(config) {
    ...
    this._inlinePopoverInstance = O9Popover.initialize(popoverHost, {
      isInline: true,
      variant: "edge",
      title: config.title ?? "",
