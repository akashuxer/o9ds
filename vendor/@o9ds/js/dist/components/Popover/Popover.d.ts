export interface O9PopoverActionConfig {
    id: string;
    label?: string;
    icon?: string;
...
export interface O9PopoverHeaderActionConfig {
    id: string;
...
export interface O9PopoverOptions {
    variant?: 'space' | 'edge';
...
type RequiredPopoverOptions = Required<Omit<O9PopoverOptions, 'onOpen' | 'onClose' | 'onBack' | 'stickyHeader' | 'content' | 'width'>> & {
    stickyHeader: HTMLElement | string | ((el: HTMLElement) => void) | null;
    content: HTMLElement | string | ((el: HTMLElement) => void) | null;
    width: string | number | 'anchor' | null;
...
export declare class O9Popover {
    private _element;
    private _options;
    private _panelEl;
    private _arrowEl;
    ...
    static initialize(element: HTMLElement, options?: O9PopoverOptions): O9Popover;
    constructor(element: HTMLElement, options?: O9PopoverOptions);
    private _render;
