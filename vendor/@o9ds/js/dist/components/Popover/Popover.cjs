...
const _O9Popover = class _O9Popover {
  constructor(element, options) {
    ...
    this._panelId = `o9ds-popover-${++_idCounter}`;
    this._options = {
      ..._O9Popover.DEFAULTS,
      ...options,
  ...
  static initialize(element, options) {
    return new _O9Popover(element, options);
  }
  // ---------------------------------------------------------------------------
  // Render
  // ---------------------------------------------------------------------------
  _render() {
    ...
    if (this._options.hasArrow) {
      ...
      this._arrowEl.className = "o9ds-popover__arrow";
  ...
  _renderHeader(titleId) {
    ...
    this._headerEl.className = "o9ds-popover__header";
    const headerLeft = document.createElement("div");
    headerLeft.className = "o9ds-popover__header-left";
    if (this._options.hasBackButton) {
      const backBtnEl = document.createElement("button");
      backBtnEl.className = "o9ds-popover__back-btn";
      this._backBtnInstance = IconButton.O9IconButton.initialize(backBtnEl, {
        variant: "tertiary",
        size: "sm",
        icon: "arrow-left",
        tooltip: "Back",
    ...
    if (this._options.isClosable) {
      ...
      closeBtnEl.className = "o9ds-popover__close-btn";
      this._closeBtnInstance = IconButton.O9IconButton.initialize(closeBtnEl, {
        variant: "tertiary",
        size: "sm",
        icon: "close",
        tooltip: "Close",
  ...
  _renderFooter() {
    ...
    this._footerEl.className = "o9ds-popover__footer";
    for (const action of this._options.actions) {
      if (action.icon && !action.label) {
        ...
        const btnEl = document.createElement("button");
        const inst = Button.O9Button.initialize(btnEl, {
  ...
  _buildPanelClasses() {
    ...
    return [
      ...
      actions.length > 0 && hasFooter && "o9ds-popover--with-footer",
  ...
  _applyWidth() {
    ...
    if (w == null) {
      this._panelEl.style.removeProperty("--o9ds-popover-width");
    } else if (w === "anchor" && this._element) {
      this._panelEl.style.setProperty("--o9ds-popover-width", `${this._element.offsetWidth}px`);
    } else if (typeof w === "number") {
      this._panelEl.style.setProperty("--o9ds-popover-width", `${w}px`);
    } else if (typeof w === "string") {
      this._panelEl.style.setProperty("--o9ds-popover-width", w);
    }
  }
  // ---------------------------------------------------------------------------
  // Positioning
  ...
  _applyPosition(result) {
    ...
    if (result.width != null) {
      this._panelEl.style.setProperty("--o9ds-popover-width", result.width);
    }
  }
  // ---------------------------------------------------------------------------
  // Public API
