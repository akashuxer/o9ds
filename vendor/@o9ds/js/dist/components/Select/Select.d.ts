...
export interface O9SelectOptions {
...
type RequiredSelectOptions = Required<Omit<O9SelectOptions, 'onChange' | 'onOpen' | 'onClose' | 'onOpenChange' | 'maxHeight' | 'errorMsg' | 'search' | 'width'>> & {
...
export declare class O9Select {
    ...
    static initialize(element: HTMLElement, options: O9SelectOptions): O9Select;
    constructor(element: HTMLElement, options: O9SelectOptions);
    private _buildRoot;
    private _buildPanel;
