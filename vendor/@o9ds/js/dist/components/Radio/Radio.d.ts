export interface O9RadioOptions {
    value: string;
    name: string;
    label?: string | null;
    isChecked?: boolean;
...
type RequiredRadioOptions = Required<Omit<O9RadioOptions, 'onChange' | 'onFocus' | 'onBlur'>> & {
    onChange: ((detail: {
        value: string;
        name: string;
    }) => void) | null;
...
export declare class O9Radio {
    ...
    static initialize(element: HTMLElement, options?: O9RadioOptions): O9Radio;
    constructor(element: HTMLElement, options?: O9RadioOptions);
    private _render;
    private _bindEvents;
