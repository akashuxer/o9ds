export interface O9LinkOptions {
...
type RequiredLinkOptions = Required<Omit<O9LinkOptions, 'onClick' | 'icon' | 'target'>> & {
    icon: string | null;
    target: string | null;
    onClick: ((event: Event) => void) | null;
};
export declare class O9Link {
    private _element;
    private _options;
    private _iconEl;
    private _labelEl;
    ...
    static initialize(element: HTMLAnchorElement, options?: O9LinkOptions): O9Link;
    constructor(element: HTMLAnchorElement, options?: O9LinkOptions);
    private _render;
