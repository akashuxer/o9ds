...
const _O9FabButton = class _O9FabButton {
  ...
  _createInnerButton() {
    ...
    if (this._options.label !== null) {
      this._innerButton = new Button.O9Button(this._buttonEl, {
      ...
      this._innerButton = new IconButton.O9IconButton(this._buttonEl, {
        variant: this._options.variant,
        size: "lg",
        icon: this._options.icon,
  ...
  setLabel(label) {
    ...
    if (wasWithLabel !== isWithLabel) {
      ...
      this._createInnerButton();
      this._applyWrapperClasses();
    } else if (isWithLabel && this._innerButton instanceof Button.O9Button) {
...
exports.O9FabButton = O9FabButton;
