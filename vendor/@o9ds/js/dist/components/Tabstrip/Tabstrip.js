...
const _O9Tabstrip = class _O9Tabstrip {
  ...
  _render() {
    ...
    this._overflowMenuInstance = O9ActionMenu.initialize(this._overflowBtnEl, {
      items: [],
    ...
    O9IconButton.initialize(this._overflowBtnEl, {
      icon: "ellipsis-v",
      variant: "tertiary",
  ...
  _createTabEntry(tab) {
    ...
    if (showActions && (tabPinnable || tabClosable)) {
      ...
      if (tabPinnable) {
        ...
        pinBtn = O9IconButton.initialize(pinBtnEl, {
      ...
      if (tabClosable) {
        ...
        closeBtn = O9IconButton.initialize(closeBtnEl, {
          icon: "close",
          variant: "tertiary",
          size: this._iconBtnSize(),
          tooltip: "Close tab",
