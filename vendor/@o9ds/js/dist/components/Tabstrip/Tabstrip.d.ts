...
export interface O9TabstripOptions {
...
type RequiredOptions = Required<Omit<O9TabstripOptions, 'onSelect' | 'onClose' | 'onPin' | 'selectedId'>> & {
    selectedId: string | null;
    onSelect: ((detail: {
        id: string;
        index: number;
...
export declare class O9Tabstrip {
    private _element;
    private _options;
    private _listEl;
    ...
    static initialize(element: HTMLElement, options?: O9TabstripOptions): O9Tabstrip;
    constructor(element: HTMLElement, options?: O9TabstripOptions);
