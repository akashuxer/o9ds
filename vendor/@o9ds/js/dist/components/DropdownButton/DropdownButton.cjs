...
const _O9DropdownButton = class _O9DropdownButton {
  constructor(element, options) {
    ...
    const variant = (options == null ? void 0 : options.variant) && _O9DropdownButton.VARIANTS.includes(options.variant) ? options.variant : _O9DropdownButton.DEFAULTS.variant;
    const size = (options == null ? void 0 : options.size) && _O9DropdownButton.SIZES.includes(options.size) ? options.size : _O9DropdownButton.DEFAULTS.size;
    this._options = {
      ..._O9DropdownButton.DEFAULTS,
      ...options,
      variant,
      size,
  ...
  static initialize(element, options) {
    return new _O9DropdownButton(element, options);
  }
  _connectTooltip() {
  ...
  _render() {
    ...
    if (!el) return;
    el.textContent = "";
    el.classList.add("o9ds-dd-btn", "o9ds-btn");
  ...
  _initActionMenu() {
    ...
    this._actionMenu = ActionMenu.O9ActionMenu.initialize(this._element, menuOptions);
  }
  // ---------------------------------------------------------------------------
  // Selection Logic
  // ---------------------------------------------------------------------------
  ...
  setIcon(iconName) {
    ...
    if (this._iconEl) {
      ...
      this._iconEl = document.createElement("span");
      this._iconEl.className = `o9ds-dd-btn__icon o9con o9con-${iconName}`;
      this._iconEl.setAttribute("aria-hidden", "true");
  ...
  setVariant(variant) {
    if (!_O9DropdownButton.VARIANTS.includes(variant))
      return;
    const el = this._element;
    if (!el) return;
    _O9DropdownButton.VARIANTS.forEach(
  ...
  setSize(size) {
    if (!_O9DropdownButton.SIZES.includes(size)) return;
    const el = this._element;
    if (!el) return;
    _O9DropdownButton.SIZES.forEach(
...
_O9DropdownButton.VARIANTS = ["primary", "secondary", "tertiary", "outline"];
_O9DropdownButton.SIZES = ["sm", "md", "lg"];
_O9DropdownButton.DEFAULTS = {
  label: "",
  variant: "primary",
  size: "md",
...
let O9DropdownButton = _O9DropdownButton;
exports.O9DropdownButton = O9DropdownButton;
