...
export interface O9ButtonOptions {
...
type RequiredButtonOptions = Required<Omit<O9ButtonOptions, 'onClick' | 'tooltip' | 'icon' | 'isSelected'>> & {
    icon: string | null;
    tooltip: ButtonTooltipOption | null;
    onClick: ((event: Event) => void) | null;
    isSelected: boolean | undefined;
};
export declare class O9Button {
    private _element;
    private _options;
    private _iconEl;
    private _labelEl;
    ...
    static initialize(element: HTMLButtonElement, options?: O9ButtonOptions): O9Button;
    constructor(element: HTMLButtonElement, options?: O9ButtonOptions);
