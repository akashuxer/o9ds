export interface O9SearchOptions {
    variant?: 'filter' | 'find';
    value?: string;
    placeholder?: string;
    isDisabled?: boolean;
...
type RequiredSearchOptions = Required<Omit<O9SearchOptions, 'onSearch' | 'onInput' | 'onChange' | 'onClear' | 'onFocus' | 'onBlur' | 'onNext' | 'onPrevious' | 'errorMsg' | 'shortcut' | 'counter' | 'width'>> & {
    width: string | null;
...
export declare class O9Search {
    ...
    static initialize(element: HTMLDivElement, options?: O9SearchOptions): O9Search;
    constructor(element: HTMLDivElement, options?: O9SearchOptions);
    private _render;
    private _bindEvents;
