...
const _O9Search = class _O9Search {
  ...
  _render() {
    ...
    if (effectiveClearable) {
      ...
      this._clearBtn = IconButton.O9IconButton.initialize(this._clearEl, {
        size: "sm",
        variant: "tertiary",
        icon: "close",
        tooltip: "Clear",
    ...
    if (variant === "find") {
      ...
      this._prevBtn = IconButton.O9IconButton.initialize(this._prevEl, {
        size: "sm",
        variant: "tertiary",
        icon: "angle-up",
      ...
      this._nextBtn = IconButton.O9IconButton.initialize(this._nextEl, {
        size: "sm",
        variant: "tertiary",
        icon: "angle-down",
        tooltip: "Next match",
