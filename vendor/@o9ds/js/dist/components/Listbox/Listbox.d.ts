...
export interface O9ListboxOptions {
...
type RequiredListboxOptions = Required<Omit<O9ListboxOptions, 'onChange' | 'onHighlight' | 'onFilter' | 'value' | 'search'>> & {
...
export declare class O9Listbox {
    private _element;
    private _options;
    private _id;
    private _listEl;
    ...
    static initialize(element: HTMLElement, options: O9ListboxOptions): O9Listbox;
    constructor(element: HTMLElement, options: O9ListboxOptions);
