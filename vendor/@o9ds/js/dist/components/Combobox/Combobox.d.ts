...
export interface O9ComboboxOptions {
...
type RequiredComboboxOptions = Required<Omit<O9ComboboxOptions, 'onChange' | 'onInputChange' | 'onOpen' | 'onClose' | 'onClear' | 'onOpenChange' | 'maxHeight' | 'errorMsg' | 'filterFn' | 'inputValue' | 'isInlineError' | 'width'>> & {
    isInlineError: boolean;
...
export declare class O9Combobox {
    private _element;
    private _options;
    private _fieldEl;
    private _inputEl;
    ...
    static initialize(element: HTMLElement, options: O9ComboboxOptions): O9Combobox;
    constructor(element: HTMLElement, options: O9ComboboxOptions);
    private _buildRoot;
    private _buildPanel;
