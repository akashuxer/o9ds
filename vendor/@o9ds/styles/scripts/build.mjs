/**
 * Build script for @o9ds/styles.
 * Compiles _index.scss → dist/o9ds.css + dist/o9ds.min.css
 *
...
const outExpanded = join(distDir, 'o9ds.css');
const outMinified = join(distDir, 'o9ds.min.css');
...
console.log(`  dist/o9ds.css → dist/o9ds.min.css  (${ratio}% smaller)`);
console.log('Done.');
