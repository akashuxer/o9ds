export interface O9PopoverAction {
    id?: string;
    label?: string;
    icon?: string;
...
export interface O9PopoverHeaderAction {
    id: string;
...
export interface O9PopoverProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'content' | 'title'> {
    variant?: 'space' | 'edge';
...
declare const O9Popover: import('react').ForwardRefExoticComponent<O9PopoverProps & import('react').RefAttributes<HTMLDivElement>>;
export { O9Popover };
export default O9Popover;
