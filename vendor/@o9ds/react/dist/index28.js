    ...
    const tabElements = displayOrder.map((tab) => {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("span", { className: "o9ds-tabs__tab-lft", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "o9ds-tabs__tab-lbl", children: tab.label })
            ] }),
            showActions && (tabPinnable || tabClosable) && /* @__PURE__ */ jsxs("span", { className: "o9ds-tabs__tab-actions", children: [
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { ref: overflowBtnRef, className: "o9ds-tabs__overflow-btn", children: hasOverflow ? /* @__PURE__ */ jsx(
            O9ActionMenu,
            {
