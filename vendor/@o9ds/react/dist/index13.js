...
const O9Textbox = forwardRef(
  function O9Textbox2({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, className: classes, style: rootStyle, role: "group", "aria-busy": isLoading || void 0, children: [
      label && /* @__PURE__ */ jsx(FormLabel, { htmlFor: inputId, size: "sm", isRequired, isDisabled, className: "o9ds-textbox__lbl", children: label }),
      /* @__PURE__ */ jsxs("div", { ref: fieldRef, className: "o9ds-textbox__field", children: [
        ...
        /* @__PURE__ */ jsxs("div", { ref: actionsRef, className: "o9ds-textbox__actions", children: [
          ...
          isInlineError && isInvalid && /* @__PURE__ */ jsx("span", { ref: errIcoRef, className: "o9ds-textbox__err-ico", "aria-hidden": "true" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "o9ds-textbox__border" })
      ] }),
      hasCounter && !showInlineAlert && /* @__PURE__ */ jsx("span", { className: "o9ds-textbox__counter", children: formatCharCount(currentValue.length, maxLength ?? null) }),
