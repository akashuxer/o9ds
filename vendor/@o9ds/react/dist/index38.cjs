...
const O9Listbox = react.forwardRef(
  function O9Listbox2({
    items,
    value,
    defaultValue,
    ...
    const classes = [
      "o9ds-listbox",
      `o9ds-listbox--${size}`,
      isMultiple && "o9ds-listbox--multiple",
      searchCfg && "o9ds-listbox--searchable",
      isLoading && "loading",
        ...
        "div",
        {
          ...
          children: [
            item.icon && /* @__PURE__ */ jsxRuntime.jsx(
              "span",
              {
                className: `o9ds-listbox__opt__ico o9con o9con-${item.icon}`,
                "aria-hidden": "true"
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "o9ds-listbox__opt__lbl", children: item.label })
          ]
        },
        item.id
      );
    ...
    const renderContent = () => {
      if (isLoading) {
        return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-listbox__skeleton", children: [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "o9ds-listbox__skeleton-row", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-listbox__skeleton-icon" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              className: "o9ds-listbox__skeleton-text",
      ...
      if (flatOptions.length === 0) {
        return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-listbox__empty", role: "status", children: emptyMessage });
      }
        ...
        return filteredItems.map(
          (group, groupIdx) => {
            ...
            return /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
              groupIdx > 0 && hasGroupDividers && /* @__PURE__ */ jsxRuntime.jsx("hr", { className: "o9ds-listbox__divider", role: "separator" }),
              /* @__PURE__ */ jsxRuntime.jsxs(
                "div",
                {
                  role: "group",
                  "aria-labelledby": group.label ? groupHdrId : void 0,
                  className: "o9ds-listbox__grp",
                  children: [
                    group.label && /* @__PURE__ */ jsxRuntime.jsx("div", { id: groupHdrId, className: "o9ds-listbox__grp-hdr", children: group.label }),
