...
const O9Select = react.forwardRef(
  function O9Select2({
    items,
    value,
    defaultValue,
    ...
    const classes = [
      "o9ds-sel",
      `o9ds-sel--${size}`,
      isFullWidth && "o9ds-sel--full-width",
      searchCfg && "o9ds-sel--filterable",
      isLoading && "loading",
    ...
    const panelStyle = {
      ...
      ...maxHeight ? {
        "--o9ds-sel-panel-max-height": maxHeight
      } : {},
        ...
        "div",
        {
          ...
          children: [
            item.icon && /* @__PURE__ */ jsxRuntime.jsx(
              "span",
              {
                className: `o9ds-sel__opt__ico o9con o9con-${item.icon}`,
                "aria-hidden": "true"
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-sel__opt__txt", children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "o9ds-sel__opt__lbl", children: item.label }) })
          ]
        },
        item.id
      );
    ...
    const renderPlaceholderOption = () => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-sel__opt__txt", children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "o9ds-sel__opt__lbl", children: placeholder }) })
        },
        "__placeholder__"
      );
    };
    const renderContent = () => {
      if (flatItems.length === 0 && !hasPlaceholder) {
        return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-sel__empty", role: "status", children: "No results" });
      }
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          ...
          filteredItems.map(
            (group, groupIdx) => /* @__PURE__ */ jsxRuntime.jsxs("div", { role: "group", "aria-label": group.label, children: [
              groupIdx > 0 && hasGroupDividers && /* @__PURE__ */ jsxRuntime.jsx("hr", { className: "o9ds-sel__divider", role: "separator" }),
              group.label && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-sel__hdr", children: group.label }),
    ...
    const panel = isOpen ? reactDom.createPortal(
      /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          className: `o9ds-sel o9ds-sel--${size}`,
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-sel__scroll", children: renderContent() })
              ]
            }
          )
        }
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                ...
                children: selectedItem ? selectedItem.label : placeholder ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "o9ds-sel__placeholder", children: placeholder }) : null
              }
            ),
            isInlineError && isInvalid && /* @__PURE__ */ jsxRuntime.jsx("span", { ref: errIcoRef, className: "o9ds-sel__err-ico", "aria-hidden": "true" }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "span",
              {
                className: "o9ds-sel__ico o9con o9con-angle-down",
                "aria-hidden": "true"
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "o9ds-sel__border" })
          ]
        }
      ),
...
exports.O9Select = O9Select;
exports.default = O9Select;
