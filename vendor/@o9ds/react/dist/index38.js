...
const O9Listbox = forwardRef(
  function O9Listbox2({
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "o9ds-listbox__opt__lbl", children: item.label })
          ]
        },
        item.id
      );
    ...
    const renderContent = () => {
      if (isLoading) {
        return /* @__PURE__ */ jsx("div", { className: "o9ds-listbox__skeleton", children: [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxs("div", { className: "o9ds-listbox__skeleton-row", children: [
          /* @__PURE__ */ jsx("div", { className: "o9ds-listbox__skeleton-icon" }),
          /* @__PURE__ */ jsx(
            "div",
            {
      ...
      if (flatOptions.length === 0) {
        return /* @__PURE__ */ jsx("div", { className: "o9ds-listbox__empty", role: "status", children: emptyMessage });
      }
        ...
        return filteredItems.map(
          (group, groupIdx) => {
            ...
            return /* @__PURE__ */ jsxs("div", { children: [
              groupIdx > 0 && hasGroupDividers && /* @__PURE__ */ jsx("hr", { className: "o9ds-listbox__divider", role: "separator" }),
              /* @__PURE__ */ jsxs(
                "div",
                {
                  role: "group",
                  ...
                  children: [
                    group.label && /* @__PURE__ */ jsx("div", { id: groupHdrId, className: "o9ds-listbox__grp-hdr", children: group.label }),
