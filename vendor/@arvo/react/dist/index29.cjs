...
const ArvoBreadcrumb = react.forwardRef(
  function ArvoBreadcrumb2({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "nav",
      {
        ...
        className: classes,
        children: /* @__PURE__ */ jsxRuntime.jsx("ol", { className: "arvo-bc__list", children: items.map((item, index) => {
          const isLast = index === lastIndex;
          const isIconOnly = !!item.icon && !item.label;
          return /* @__PURE__ */ jsxRuntime.jsx("li", { className: "arvo-bc__item", children: isLast ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "arvo-bc__lbl", "aria-current": "page", children: item.label }) : /* @__PURE__ */ jsxRuntime.jsxs(
            "a",
            {
...
exports.default = ArvoBreadcrumb;
