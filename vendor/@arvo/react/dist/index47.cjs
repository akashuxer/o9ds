...
const PinButton = react.forwardRef(function PinButton2({ isPinned, isDisabled, onClick }, ref) {
...
function SidePanelInner(props, ref) {
  ...
  const [variantOverride, setVariantOverride] = react.useState(null);
  ...
  react.useEffect(() => {
    ...
    if (open) {
      ...
      setTrapActive(false);
      void core.exit({ element: host, type: "fade" });
  ...
  const splitterResolved = react.useMemo(() => {
  ...
  const splitterEl = splitterResolved ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "arvo-sp__splitter", "aria-hidden": "true" }) : null;
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(
              PanelShell.PanelShell,
              {
                ...
                onItemActivate,
                onTabSelect,
                pinSlot: isPinnable ? /* @__PURE__ */ jsxRuntime.jsx(
                  PinButton,
                  {
                    ref: pinBtnRef,
...
const ArvoSidePanel = react.forwardRef(SidePanelInner);
ArvoSidePanel.displayName = "ArvoSidePanel";
exports.ArvoSidePanel = ArvoSidePanel;
