...
const ArvoDropdownButton = react.forwardRef(
    ...
    const triggerElement = /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "arvo-dd-btn__lbl", children: displayLabel }),
...
exports.default = ArvoDropdownButton;
