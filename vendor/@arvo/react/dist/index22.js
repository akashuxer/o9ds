...
import ArvoButtonGroup from "./index23.js";
import FilterList from "./index46.js";
import { EmptyState } from "./index47.js";
...
const ArvoHybridPopover = forwardRef(
  function ArvoHybridPopover2(props, ref) {
    ...
    const [internalItems, setInternalItems] = useState(() => itemsProp ?? defaultItems ?? []);
    useEffect(() => {
    ...
    const renderStickyHeader = () => {
      ...
      return /* @__PURE__ */ jsxs("div", { className: "arvo-hpop__sticky", children: [
        searchEnabled && /* @__PURE__ */ jsx("div", { className: "arvo-hpop__search", children: /* @__PURE__ */ jsx(
          ArvoSearch,
          {
            variant: "filter",
            value: query,
        ...
        selection === "multi" && conditional && /* @__PURE__ */ jsx("div", { className: "arvo-hpop__cond", children: /* @__PURE__ */ jsx(
          ArvoButtonGroup,
          {
    ...
    const renderBody = () => {
      if (isLoading) {
        return /* @__PURE__ */ jsx("div", { className: "arvo-hpop__list", "aria-hidden": "true", children: Array.from({ length: SKELETON_ROW_COUNT }, (_, i) => /* @__PURE__ */ jsx("div", { className: "arvo-hpop__skeleton" }, i)) });
      }
      if (totalCount === 0) {
    ...
    const [resizedHeight, setResizedHeight] = useState(height);
    const firstOpenRef = useRef(true);
    const lastWidthPropRef = useRef(width);
    const lastHeightPropRef = useRef(height);
    useEffect(() => {
