...
export interface ArvoComboboxProps {
...
declare const ArvoCombobox: import('react').ForwardRefExoticComponent<ArvoComboboxProps & import('react').RefAttributes<HTMLDivElement>>;
export { ArvoCombobox };
export default ArvoCombobox;
