  ...
  function ArvoCheckbox2({
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...rest,
        children: [
          /* @__PURE__ */ jsxs("label", { className: "arvo-checkbox__field", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                ref: inputRef,
            ...
            label && /* @__PURE__ */ jsx("span", { className: "arvo-checkbox__lbl", children: label })
          ] }),
          showAlert && /* @__PURE__ */ jsxs("div", { className: "arvo-inline-alert arvo-inline-alert--error", id: errorId, role: "alert", children: [
