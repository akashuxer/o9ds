...
const ArvoTabstrip = react.forwardRef(
    ...
    const tabElements = displayOrder.map((tab) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "arvo-tabs__tab-lft", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "arvo-tabs__tab-lbl", children: tab.label })
            ] }),
            showActions && (tabPinnable || tabClosable) && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "arvo-tabs__tab-actions", children: [
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { ref: overflowBtnRef, className: "arvo-tabs__overflow-btn", children: hasOverflow ? /* @__PURE__ */ jsxRuntime.jsx(
