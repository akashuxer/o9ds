export interface SortableListOptions {
    ...
    onCancel?: () => void;
    /** CSS class applied to the original item while dragging (placeholder). Default: 'arvo-sortable--ghost'. */
    ghostClass?: string;
    /** CSS class applied to the cloned drag image. Default: 'arvo-sortable--dragging'. */
    draggingClass?: string;
    /** CSS class for the drop line indicator above a target. Default: 'arvo-sortable--drop-above'. */
    dropAboveClass?: string;
    /** CSS class for the drop line indicator below a target. Default: 'arvo-sortable--drop-below'. */
