...
type RequiredActionMenuOptions = Required<Omit<ArvoActionMenuOptions, 'onOpen' | 'onClose' | 'onSelect' | 'onOpenChange' | 'maxHeight' | 'search'>> & {
...
export declare class ArvoActionMenu {
    ...
    constructor(element: HTMLElement, options: ArvoActionMenuOptions);
    private _buildPanel;
