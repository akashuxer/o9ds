...
_ArvoIconButtonLink.VARIANTS = ["primary", "secondary", "tertiary", "outline", "danger"];
_ArvoIconButtonLink.SIZES = ["xs", "sm", "md", "lg"];
_ArvoIconButtonLink.DEFAULTS = {
  variant: "primary",
  size: "md",
  icon: "",
...
exports.ArvoIconButtonLink = ArvoIconButtonLink;
//# sourceMappingURL=IconButtonLink.cjs.map
