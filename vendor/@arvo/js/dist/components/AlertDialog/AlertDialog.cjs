...
const Textbox = require("../Textbox/Textbox.cjs");
...
class ArvoAlertDialog {
  ...
  open() {
    ...
    core.enter({ element: this._panelEl, type: "scale", duration: 150 });
    if (this._backdropEl) {
      core.enter({ element: this._backdropEl, type: "fade", duration: 100 });
    }
  ...
  close(reason = "programmatic") {
    ...
    if (backdrop) {
      core.exit({ element: backdrop, type: "fade", duration: 100 });
    }
  ...
  _renderHeader() {
    ...
    if (o.isClosable) {
      ...
      this._closeBtnInstance = IconButton.ArvoIconButton.initialize(btnEl, {
        variant: "tertiary",
        size: "sm",
        icon: "close",
        tooltip: "Close",
  ...
  _renderBody() {
    ...
    if (o.confirmInput) {
      ...
      this._confirmInputInstance = Textbox.ArvoTextbox.initialize(tbEl, {
        size: "sm",
        isFullWidth: true,
  ...
  _renderFooter() {
    ...
    if (o.dontShowAgain) {
      ...
      this._dontShowInstance = Checkbox.ArvoCheckbox.initialize(cbEl, {
        size: "sm",
        label,
    ...
    if (showSecondary && o.secondaryAction) {
      ...
      this._secondaryBtnInstance = Button.ArvoButton.initialize(secEl, {
        variant: "secondary",
        size: "md",
    ...
    this._primaryBtnInstance = Button.ArvoButton.initialize(primaryEl, {
