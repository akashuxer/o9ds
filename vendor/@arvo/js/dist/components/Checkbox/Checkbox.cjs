...
const _ArvoCheckbox = class _ArvoCheckbox {
  ...
  _render() {
    ...
    this._inputId = `arvo-checkbox-${uid}`;
    this._errorId = `arvo-checkbox-err-${uid}`;
    const {
      label,
      isChecked,
      isIndeterminate,
    ...
    el.classList.add("arvo-checkbox", `arvo-checkbox--${size}`);
    ...
    this._fieldEl.className = "arvo-checkbox__field";
    this._inputEl = document.createElement("input");
    this._inputEl.className = "arvo-checkbox__input";
  ...
  destroy() {
    ...
    _ArvoCheckbox.SIZES.forEach((s) => el.classList.remove(`arvo-checkbox--${s}`));
...
exports.ArvoCheckbox = ArvoCheckbox;
