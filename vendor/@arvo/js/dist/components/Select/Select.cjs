...
const _ArvoSelect = class _ArvoSelect {
  constructor(element, options) {
    ...
    this._panelId = `arvo-sel-${++_idCounter}`;
    this._options = {
  ...
  _buildRoot() {
    ...
    this._triggerEl.className = "arvo-sel__input";
    ...
    this._chevronEl.className = "arvo-sel__ico o9con o9con-angle-down";
  ...
  _buildPanel() {
    ...
    this._panelWrapperEl.className = `arvo-sel arvo-sel--${this._options.size}`;
    this._panelWrapperEl.style.display = "contents";
    this._panelEl = document.createElement("div");
    this._panelEl.id = this._panelId;
    this._panelEl.className = "arvo-sel__panel";
    ...
    if (this._options.maxHeight) {
      this._panelEl.style.setProperty("--arvo-sel-panel-max-height", this._options.maxHeight);
    }
    if (this._searchCfg) {
    ...
    this._scrollEl.className = "arvo-sel__scroll";
  ...
  _buildSearch() {
    ...
    const classes = ["arvo-sel__search"];
  ...
  _applyRootClasses() {
    const el = this._element;
    if (!el) return;
    el.classList.add("arvo-sel", `arvo-sel--${this._options.size}`);
    el.classList.toggle("arvo-sel--full-width", this._options.isFullWidth);
    el.classList.toggle("arvo-sel--filterable", !!this._searchCfg);
  ...
  _renderItems() {
    ...
    if (isGrouped(items)) {
      items.forEach((group, groupIndex) => {
        if (groupIndex > 0 && this._options.hasGroupDividers) {
          ...
          divider.className = "arvo-sel__divider";
        ...
        if (group.label) {
          ...
          header.className = "arvo-sel__hdr";
    ...
    if (this._flatItems.length === 0 && this._query && !hasPlaceholder) {
      ...
      empty.className = "arvo-sel__empty";
  ...
  _renderPlaceholderItemInto(container) {
    ...
    txt.className = "arvo-sel__opt__txt";
    const lbl = document.createElement("span");
    lbl.className = "arvo-sel__opt__lbl";
  ...
  _renderItemInto(item, container) {
    ...
    if (item.icon) {
      ...
      ico.className = `arvo-sel__opt__ico o9con o9con-${item.icon}`;
  ...
  _updateValueDisplay() {
    ...
    if (selectedItem) {
      ...
      if (this._options.placeholder) {
        ...
        span.className = "arvo-sel__placeholder";
