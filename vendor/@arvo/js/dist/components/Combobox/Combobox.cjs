...
const _ArvoCombobox = class _ArvoCombobox {
  ...
  _buildRoot() {
    ...
    if (this._options.isClearable) {
      ...
      this._clearBtnInstance = IconButton.ArvoIconButton.initialize(this._clearBtnEl, {
        variant: "tertiary",
        size: "sm",
        icon: "close",
        tooltip: "Clear",
    ...
    this._chevronBtnInstance = IconButton.ArvoIconButton.initialize(this._chevronEl, {
      variant: "tertiary",
      size: "sm",
      icon: "angle-down",
