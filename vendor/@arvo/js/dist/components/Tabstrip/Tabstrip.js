...
const _ArvoTabstrip = class _ArvoTabstrip {
  ...
  _render() {
    ...
    el.classList.add("arvo-tabs", `arvo-tabs--${variant}`, `arvo-tabs--${size}`);
    if (actionsVisibility === "always") el.classList.add("arvo-tabs--actions-always");
    ...
    this._overflowMenuInstance = ArvoActionMenu.initialize(this._overflowBtnEl, {
      items: [],
    ...
    ArvoIconButton.initialize(this._overflowBtnEl, {
      icon: "ellipsis-v",
      variant: "tertiary",
  ...
  _createTabEntry(tab) {
    ...
    if (this._options.actionsVisibility === "hover") {
      ...
      if (actionsW > 0) {
        btn.style.setProperty("--arvo-tabs-actions-w", `${actionsW}px`);
      }
    }
    ...
    if (showActions && (tabPinnable || tabClosable)) {
      ...
      if (tabPinnable) {
        ...
        pinBtn = ArvoIconButton.initialize(pinBtnEl, {
      ...
      if (tabClosable) {
        ...
        closeBtn = ArvoIconButton.initialize(closeBtnEl, {
          icon: "close",
          variant: "tertiary",
          size: this._iconBtnSize(),
          tooltip: "Close tab",
...
_ArvoTabstrip.VARIANTS = ["primary", "secondary", "tertiary"];
