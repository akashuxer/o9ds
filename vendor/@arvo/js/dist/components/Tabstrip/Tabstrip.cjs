...
const _ArvoTabstrip = class _ArvoTabstrip {
  ...
  _render() {
    ...
    this._overflowMenuInstance = ActionMenu.ArvoActionMenu.initialize(this._overflowBtnEl, {
      items: [],
    ...
    IconButton.ArvoIconButton.initialize(this._overflowBtnEl, {
      icon: "ellipsis-v",
      variant: "tertiary",
  ...
  _createTabEntry(tab) {
    ...
    if (showActions && (tabPinnable || tabClosable)) {
      ...
      if (tabPinnable) {
        ...
        pinBtn = IconButton.ArvoIconButton.initialize(pinBtnEl, {
