export interface ArvoSwitchOptions {
    label?: string | null;
    isChecked?: boolean;
    isDisabled?: boolean;
    isReadOnly?: boolean;
...
type RequiredSwitchOptions = Required<Omit<ArvoSwitchOptions, 'onChange' | 'onFocus' | 'onBlur' | 'name' | 'label'>> & {
    label: string | null;
...
export declare class ArvoSwitch {
    private _element;
    private _options;
    private _inputEl;
    private _fieldEl;
    ...
    static initialize(element: HTMLElement, options?: ArvoSwitchOptions): ArvoSwitch;
    constructor(element: HTMLElement, options?: ArvoSwitchOptions);
    private _render;
