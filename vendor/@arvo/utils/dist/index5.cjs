...
function runItemFilter(items, query, opts) {
  ...
  return core.filterItems(items, filterOpts);
}
...
exports.formatMatchCountMessage = formatMatchCountMessage;
exports.runItemFilter = runItemFilter;
exports.validateHeaderAction = validateHeaderAction;
