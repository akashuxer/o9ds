...
| 2026-05-12 | **Home:** Storybook card → `/storybook/` (same-origin, see `public/storybook/README.md`) + `public/home/storybook.png`; Figma Make card → `public/home/make.png` (both + WebP via build pipeline). |
