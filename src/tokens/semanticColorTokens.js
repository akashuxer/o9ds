...
const SEMANTIC_SURFACE_ROWS = [
  ...
  { token: 'arvo-color-s-positive-subtle', lightGlobal: 'arvo-global-positive-08', darkGlobal: 'arvo-global-gray-08', useCase: 'Subtle positive / success background.' },
...
const TEXT_FIGMA_TOKEN_ORDER = [
  ...
  'arvo-color-t-util-purple-dark',
  'arvo-color-t-util-pink-dark',
  'arvo-color-t-util-glacier-dark',
  'arvo-color-t-util-amber-dark',
  'arvo-color-t-util-greenish-dark',
  'arvo-color-t-util-bluish-dark',
]
...
const SEMANTIC_TEXT_ROWS = [
  ...
  { token: 'arvo-color-t-util-purple-dark', lightGlobal: 'arvo-global-purple-10', darkGlobal: 'arvo-global-purple-09', useCase: 'Utility purple text (Figma: purple).' },
  { token: 'arvo-color-t-util-pink-dark', lightGlobal: 'arvo-global-pink-10', darkGlobal: 'arvo-global-pink-08', useCase: 'Utility pink text (Figma: pink).' },
  { token: 'arvo-color-t-util-glacier-dark', lightGlobal: 'arvo-global-glacier-10', darkGlobal: 'arvo-global-glacier-08', useCase: 'Utility glacier text (Figma: glacier).' },
  { token: 'arvo-color-t-util-amber-dark', lightGlobal: 'arvo-global-amber-10', darkGlobal: 'arvo-global-amber-08', useCase: 'Utility amber text (Figma: amber).' },
  { token: 'arvo-color-t-util-greenish-dark', lightGlobal: 'arvo-global-greenish-10', darkGlobal: 'arvo-global-greenish-08', useCase: 'Utility greenish text (Figma: greenish).' },
  { token: 'arvo-color-t-util-bluish-dark', lightGlobal: 'arvo-global-bluish-10', darkGlobal: 'arvo-global-bluish-07', useCase: 'Utility bluish text (Figma: bluish).' },
]
...
const ICON_FIGMA_TOKEN_ORDER = [
  ...
  'arvo-color-i-util-purple-dark',
  'arvo-color-i-util-pink-dark',
  'arvo-color-i-util-glacier-dark',
  'arvo-color-i-util-amber-dark',
  'arvo-color-i-util-greenish-dark',
  'arvo-color-i-util-bluish-dark',
...
const SEMANTIC_ICON_ROWS = [
  ...
  { token: 'arvo-color-i-util-purple-dark', lightGlobal: 'arvo-global-purple-10', darkGlobal: 'arvo-global-purple-09', useCase: 'Utility purple icon (Figma: purple).' },
  { token: 'arvo-color-i-util-pink-dark', lightGlobal: 'arvo-global-pink-10', darkGlobal: 'arvo-global-pink-08', useCase: 'Utility pink icon (Figma: pink).' },
  { token: 'arvo-color-i-util-glacier-dark', lightGlobal: 'arvo-global-glacier-10', darkGlobal: 'arvo-global-glacier-08', useCase: 'Utility glacier icon (Figma: glacier).' },
  { token: 'arvo-color-i-util-amber-dark', lightGlobal: 'arvo-global-amber-10', darkGlobal: 'arvo-global-amber-08', useCase: 'Utility amber icon (Figma: amber).' },
  { token: 'arvo-color-i-util-greenish-dark', lightGlobal: 'arvo-global-greenish-10', darkGlobal: 'arvo-global-greenish-08', useCase: 'Utility greenish icon (Figma: greenish).' },
  { token: 'arvo-color-i-util-bluish-dark', lightGlobal: 'arvo-global-bluish-10', darkGlobal: 'arvo-global-bluish-07', useCase: 'Utility bluish icon (Figma: bluish).' },
  {
