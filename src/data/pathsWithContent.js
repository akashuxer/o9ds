...
export const PATHS_WITH_CONTENT = new Set([
  ...
  PATH_SYMBOL,
  docPagePath(PATH_LOGOS_BASE, 'Overview'),
  docPagePath(PATH_LOGOS_BASE, 'Logo Gallery'),
  PATH_COMPONENTS_OVERVIEW,
  PATH_CONTRIBUTE,
  docPagePath(PATH_DEV_INTRO_BASE, 'Overview'),
  docPagePath(PATH_DEV_INTRO_BASE, 'Usage'),
  docPagePath(PATH_DEV_INTRO_BASE, 'Architecture'),
  devUsageTopicPath('overview'),
  devUsageTopicPath('public-api'),
  devUsageTopicPath('components'),
  devUsageTopicPath('styling'),
  devUsageTopicPath('composition'),
  devUsageTopicPath('accessibility'),
  devUsageTopicPath('testing'),
  devUsageTopicPath('versioning'),
  devUsageTopicPath('anti-patterns'),
  devUsageTopicPath('checklist'),
  devRefTopicPath('agentic-pipeline'),
  devRefTopicPath('component-pipeline'),
  devRefTopicPath('token-pipeline'),
  devRefTopicPath('shared-patterns'),
  devRefTopicPath('testing-and-drift'),
  devRefTopicPath('workflows'),
