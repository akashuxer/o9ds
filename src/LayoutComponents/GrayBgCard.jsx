...
export default function GrayBgCard({ number, title, desc, bullets = [], decisionRule, children, className = '', style }) {
  ...
  return (
    <div
      className={`border p-6 transition-all duration-300 hover:border-arvo-light-primary dark:hover:border-neutral-600 hover:shadow-md hover:-translate-y-0.5 ${className}`}
      style={{
