...
function IllustrationCard({ item, size }) {
  ...
  const snippet = `<div class="arvo-illus arvo-illus--${item.name} arvo-illus-${size}"></div>`
    ...
    <div className="max-w-4xl space-y-8">
      <section>
        ...
        <p className="mt-4 text-arvo-light-secondary dark:text-neutral-400 max-w-2xl leading-relaxed">
          As part of the new Arvo Design System, we are introducing o9Illus, a collection of flat illustrations that are an integral part of the o9 brand.
        </p>
      ...
      {activeTab === 'Overview' && (
        <>
          <section id="o9illus-philosophy" className="border dark:border-neutral-700 p-6 md:p-8 shadow-sm bg-arvo-light-surface dark:bg-transparent">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">o9Illus Design Philosophy</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6">
              Meaningful visuals that enhance user experience and guide interactions
            </p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-8 leading-relaxed">
          ...
          <section id="usage-guidelines">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-4">Usage Guidelines</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6">Best practices for implementing o9Illus in your interfaces</p>
            <div className="border dark:border-neutral-700 p-6 space-y-6 shadow-sm dark:bg-transparent" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#FFFFFF' } : undefined}>
              <div>
                <h3 className="font-semibold text-arvo-light-primary dark:text-white mb-3">When to Use Illustrations</h3>
          ...
          <section id="sizes">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-4">Sizes</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-4">
            ...
            <div className="space-y-4 mb-6">
              <div>
                <p className="text-sm font-medium text-arvo-light-secondary dark:text-neutral-400 mb-1">Selectors include:</p>
                <div className="space-y-2">
                  <CodeBlock code="arvo-illus" label="Base" />
                  <CodeBlock code={'.arvo-illus--{illus-name}'} label="Illustration" />
                  <CodeBlock code={SIZES.map((s) => `.arvo-illus-${s}`).join('   ')} label="Size" />
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-wrap items-end justify-center gap-12">
                {SIZES.map((s) => (
                  <div key={s} className="flex flex-col items-center">
                    ...
                    <p className="mt-3 text-sm font-medium text-arvo-light-primary dark:text-white">{s}px</p>
                    <p className="text-xs text-arvo-light-secondary dark:text-neutral-400">arvo-illus-{s}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      {activeTab === 'o9Illus Gallery' && (
        <>
          <section id="illus-display-options">
            ...
            <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 mb-4">Customize how illustrations are displayed in the gallery</p>
      ...
      {activeTab === 'Accessibility' && (
        <section id="illus-accessibility" className="border dark:border-neutral-700 p-6 md:p-8 shadow-sm dark:bg-transparent" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#FFFFFF' } : undefined}>
          <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-4">Illustration Accessibility</h2>
          <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed mb-6">
      ...
      {activeTab === 'Code' && (
        <section id="illus-implementation" className="space-y-8">
          ...
          <div id="illus-size-tokens">
            <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-3">Illustration Size Tokens</h3>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-4">Copy the SCSS variables for illustration sizes:</p>
