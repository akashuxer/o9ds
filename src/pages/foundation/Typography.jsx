 ...
 * light/dark match `GLOBAL_TOKEN_HEX` mappings; `--arvo-type-variant-color` is set to that hex
 * so global `main td` !important rules still lose to index.css `[data-arvo-type-variant-preview]`.
 */
function TypeStyleVariantPreview({ token, variantLabel, underline, inverse }) {
  ...
  const baseStyle = {
    '--arvo-type-variant-color': hex,
    fontWeight: 600,
    fontFamily: 'inherit',
  }
  if (inverse) {
    const bg = isDark ? GLOBAL_TOKEN_HEX['arvo-global-gray-01'] : GLOBAL_TOKEN_HEX['arvo-global-black']
    return (
      <span
        data-arvo-type-variant-preview
...
function TokenNamingPatternCard() {
  ...
  return (
    <div
      ...
      data-arvo-dotted-card
      role="group"
      aria-label="Naming pattern: system–category–variant–size–property maps to arvo-font-h32-r with matching segment colors"
    >
      <div className="flex flex-wrap items-center gap-4 sm:gap-5">
        ...
        <span className="shrink-0 text-xl font-light text-arvo-light-secondary dark:text-neutral-500" aria-hidden>
          →
        </span>
        <div className="min-w-0 rounded-sm bg-[#010101] px-4 py-3 font-mono text-sm leading-relaxed shadow-inner">
          <span className="text-[#FCFCFD]">arvo</span>
          {hy}
...
const FONT_WEIGHT_ROWS_WITH_PREVIEW = FONT_WEIGHT_ROWS.map((r) => ({
  ...
  preview: (
    <span
      className="font-sans text-arvo-light-primary dark:text-white"
    ...
    <PageWithToc sections={sections}>
      <div className="space-y-12">
        <PageHeader
          title="Typography"
          icon={typographyIcon}
          description="The Arvo Design System uses o9Sans as its primary typeface for clarity, balance, and precision across the product."
          descClassName="mt-4 text-arvo-light-primary dark:text-neutral-200"
        />
        ...
        {activeTab === 'Overview' && (
          <div className="space-y-12">
            <section id="typography-typeface" className="space-y-6 max-w-3xl">
              ...
              <p className="text-lg text-arvo-light-primary dark:text-neutral-200 leading-relaxed">
                Arvo uses o9Sans as its primary typeface.
              </p>
              <p className="text-lg text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
              ...
              <div id="typography-fallback-stack" className="space-y-4 scroll-mt-24">
                <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white">Fallback font stack</h3>
                <p className="text-lg text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
              ...
              <div id="typography-root-font-size" className="space-y-4 scroll-mt-24">
                <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white">Root font size</h3>
                <p className="text-lg text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
                  The system is responsive and uses rem units. The base font size in Arvo is 16px (1rem).
                </p>
            ...
            <section id="typography-typescale" className="space-y-6 max-w-3xl scroll-mt-24">
              ...
              <p className="text-lg text-arvo-light-secondary dark:text-neutral-400 leading-relaxed max-w-3xl">
            ...
            <section id="naming-convention" className="space-y-6 max-w-4xl">
              ...
              <div id="naming-anatomy" className="space-y-3 scroll-mt-24">
                <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white">Anatomy</h3>
                <ol className="list-decimal list-inside space-y-2 text-lg text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
                  <li>
                    <strong className="text-arvo-light-primary dark:text-white font-medium">arvo</strong> — Prefix for the Arvo Design System.
                  </li>
                  <li>
                    <strong className="text-arvo-light-primary dark:text-white font-medium">font</strong> — Indicates a typography font token.
                  </li>
                  <li>
                    <strong className="text-arvo-light-primary dark:text-white font-medium">variant</strong> — Defines the usage category (heading, paragraph, or label).
                  </li>
                  <li>
                    <strong className="text-arvo-light-primary dark:text-white font-medium">size</strong> — Defines the font size in the token name.
                  </li>
                  <li>
                    <strong className="text-arvo-light-primary dark:text-white font-medium">property</strong> — Defines the font weight and style suffix.
                  </li>
                </ol>
              </div>

              <div id="variant-categorization" className="space-y-4 scroll-mt-24">
                <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white">Variant categorization</h3>
                <p className="text-lg text-arvo-light-secondary dark:text-neutral-400 leading-relaxed max-w-3xl">
              ...
              <div id="property-suffixes" className="space-y-4 scroll-mt-24">
                <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white">Property suffixes</h3>
            ...
            <section id="type-style-variants" className="space-y-6 max-w-4xl scroll-mt-24">
              ...
              <p className="text-lg text-arvo-light-secondary dark:text-neutral-400 leading-relaxed max-w-3xl">
                Type styles let you tune Arvo typography beyond the default scale. Variants build on top of your hierarchies so readers can
              ...
              <p className="rounded-md border border-neutral-200/90 bg-neutral-50/90 px-4 py-3 text-sm leading-relaxed text-arvo-light-secondary dark:border-neutral-700 dark:bg-neutral-900/40 dark:text-neutral-300 max-w-3xl">
                <span className="font-semibold text-arvo-light-primary dark:text-white">Note:</span> Color is not the only way to convey
        ...
        {activeTab === 'Tokens' && (
          <div className="space-y-12">
            <section id="font-weight-tokens" className="space-y-4">
              <h2 className="text-2xl font-bold text-arvo-light-primary dark:text-white">Font weight tokens</h2>
              <p className="max-w-3xl text-lg text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
                Weight adds emphasis within typographic hierarchies and can signal how important content is on screen. Arvo recommends{' '}
                <strong className="text-arvo-light-primary dark:text-white font-medium">Regular</strong> and{' '}
                <strong className="text-arvo-light-primary dark:text-white font-medium">Medium</strong> weights, and{' '}
                <strong className="text-arvo-light-primary dark:text-white font-medium">Bold</strong> only in exceptional cases, to cover
                most use cases.
              </p>
            ...
            <section id="font-size-tokens" className="space-y-4">
              <h2 className="text-2xl font-bold text-arvo-light-primary dark:text-white">Font size tokens</h2>
