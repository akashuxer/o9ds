...
function O9conIconCard({ icon, size, isLight }) {
  ...
  const snippet = `<span class="o9con ${icon.class} arvo-icon-${size}" aria-hidden="true"></span>`
    ...
    >
      <div className="flex flex-col items-center p-6">
        <div className="flex items-center justify-center shrink-0" style={{ width: size, height: size, minWidth: size, minHeight: size }}>
          <span
            className={`o9con ${icon.class} arvo-icon-${size} dark:text-white`}
  ...
  return (
    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="mt-4 text-arvo-light-secondary dark:text-neutral-400 max-w-2xl leading-relaxed">
        ...
        <div
          ref={tabListRef}
          role="tablist"
          className="mt-6 flex gap-6 border-b border-arvo-light-border dark:border-neutral-700"
          data-arvo-tabs
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`pb-3 text-sm font-medium transition-colors border-b-2 ${
                activeTab === tab
                  ? 'border-arvo-light-primary dark:border-white text-arvo-light-primary dark:text-white'
                  : 'border-transparent text-arvo-light-secondary hover:text-arvo-light-primary dark:text-neutral-400 dark:hover:text-neutral-300'
              }`}
            >
              {tab}
            </button>
      ...
      {activeTab === 'Overview' && (
        <section className="space-y-12">
          ...
          <div id="design-philosophy">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">o9Con Design Philosophy</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6">Core principles that guide o9&apos;s icon design system and creation process</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                >
                  <h3 className="font-semibold text-arvo-light-primary dark:text-white mb-2">{title}</h3>
                  <p className="text-sm text-arvo-light-secondary dark:text-neutral-400">{desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Evolution */}
          <div id="evolution">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Evolution: Old vs New Icons</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-2">Continuous improvement in design quality and user experience</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr style={{ backgroundColor: isLight ? '#F2F2F2' : undefined }} className="dark:bg-neutral-800/50">
                    <th className="py-3 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Old</th>
                    <th className="py-3 px-4 text-left font-medium text-arvo-light-primary dark:text-white">New Icons</th>
                    <th className="py-3 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Key Improvements</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t dark:border-neutral-700" style={{ borderColor: isLight ? '#E5E5E5' : undefined }}>
                    <td className="py-3 px-4 text-arvo-light-secondary dark:text-neutral-400">Thicker stroke, rounded exterior and interior corners</td>
                    <td className="py-3 px-4 text-arvo-light-secondary dark:text-neutral-400">Thinner strokes, sharp right-angled corners, more geometric and refined</td>
                    <td className="py-3 px-4 text-arvo-light-secondary dark:text-neutral-400">
                  ...
                  <tr className="border-t dark:border-neutral-700" style={{ borderColor: isLight ? '#E5E5E5' : undefined }}>
                    <td className="py-3 px-4 text-arvo-light-secondary dark:text-neutral-400">Thicker shapes, more compact composition</td>
                    <td className="py-3 px-4 text-arvo-light-secondary dark:text-neutral-400">Thinner, cleaner lines, more whitespace for clarity</td>
                    <td className="py-3 px-4 text-arvo-light-secondary dark:text-neutral-400">Unified Design Approach · Enhanced Readability</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* Icon Types */}
          <div id="icon-types">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Icon Types: Categorisation</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6">Organized icon categories that enhance user experience through logical grouping</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
          ...
          {/* Pixel Grid */}
          <div id="pixel-grid">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Pixel Grid</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-4 max-w-2xl">
              ...
              <table className="w-full text-sm">
                <tbody>
                  <tr className="border-b dark:border-neutral-700" style={{ borderColor: isLight ? '#E5E5E5' : undefined }}>
                    <th className="py-2 px-4 text-left font-medium text-arvo-light-primary dark:text-white w-40">Grid size</th>
                    <td className="py-2 px-4 text-arvo-light-secondary dark:text-neutral-400">20px × 20px</td>
                  </tr>
                  <tr>
                    <th className="py-2 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Padding</th>
                    <td className="py-2 px-4 text-arvo-light-secondary dark:text-neutral-400">2px</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* Base Grid */}
          <div id="base-grid">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Base Grid</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-2">The underlying foundation for all o9 icon design and construction</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-4 max-w-2xl">
            ...
            <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 mb-4">Avoid random decimal points in the x- and y-coordinates. All icons are drawn on a pixel-based grid.</p>
            <div className="border overflow-hidden" style={isLight ? { borderColor: '#E5E5E5' } : undefined}>
              <table className="w-full text-sm">
                <thead>
                  <tr style={{ backgroundColor: isLight ? '#F2F2F2' : undefined }} className="dark:bg-neutral-800/50">
                    <th className="py-2 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Icon size</th>
                    <th className="py-2 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Stroke width</th>
                    <th className="py-2 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Padding</th>
                    <th className="py-2 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Live area</th>
                    <th className="py-2 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Corner radius</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t dark:border-neutral-700" style={{ borderColor: isLight ? '#E5E5E5' : undefined }}>
                    <td className="py-2 px-4 text-arvo-light-secondary dark:text-neutral-400">24px</td>
                    <td className="py-2 px-4 text-arvo-light-secondary dark:text-neutral-400">1.4px</td>
                    <td className="py-2 px-4 text-arvo-light-secondary dark:text-neutral-400">2px</td>
                    <td className="py-2 px-4 text-arvo-light-secondary dark:text-neutral-400">20px</td>
                    <td className="py-2 px-4 text-arvo-light-secondary dark:text-neutral-400">0px</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* Padding */}
          <div id="padding">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Padding</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-2">Essential spacing that ensures proper icon scaling and white space</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-4 max-w-2xl">
          ...
          {/* Key Shapes */}
          <div id="key-shapes">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Key Shapes</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-2">Consistent proportions and shapes that provide structural foundation for all icons</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-4 max-w-2xl">
            ...
            <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 font-medium mb-2">4 types of basic key shapes:</p>
            <ul className="list-disc list-inside text-arvo-light-secondary dark:text-neutral-400 space-y-1 mb-6">
              <li>Circle</li>
              <li>Rectangle</li>
              <li>Square</li>
              <li>Triangle</li>
          ...
          {/* Shape Size */}
          <div id="shape-size">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Shape Size</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-2">Minimum size requirements and outline behavior for consistent icon rendering</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
          ...
          {/* Strokes */}
          <div id="strokes">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Strokes</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-2">Visual weight consistency and stroke specifications for all icons</p>
            <ul className="mb-6 max-w-2xl list-disc space-y-2 pl-5 text-arvo-light-secondary dark:text-neutral-400 marker:text-arvo-light-secondary dark:marker:text-neutral-400">
          ...
          {/* Angles */}
          <div id="angles">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Angles</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-2">Consistent angle increments that create harmony across the icon set</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
          ...
          {/* Action */}
          <div id="action">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Action</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-2">Step-by-step icon creation process following o9 design guidelines</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
            ...
            <ol className="list-decimal list-inside space-y-4 text-arvo-light-secondary dark:text-neutral-400">
              <li><strong className="text-arvo-light-primary dark:text-white">Move the angle grid</strong> — Place the angle grid on the side of the 20×20px grid.</li>
              <li><strong className="text-arvo-light-primary dark:text-white">Design within 9° increments</strong> — Start the icon design; it doesn&apos;t have to be centered as long as the degrees are carefully designed first.</li>
              <li><strong className="text-arvo-light-primary dark:text-white">Center the shape</strong> — When angles are defined, center the shape on the grid for perfect symmetry.</li>
            </ol>
            <ul className="mt-4 mb-6 list-disc list-inside text-sm text-arvo-light-secondary dark:text-neutral-400 space-y-1">
          ...
          <div id="combining-multiple-actions">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Combining Multiple Actions</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-4 max-w-2xl">
          ...
          <div id="dos-and-donts">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Dos and Don&apos;ts</h2>
            <h3 className="text-base font-semibold text-arvo-light-primary dark:text-white mb-2">Dos:</h3>
            <ul className="mb-6 max-w-2xl list-disc space-y-2 pl-5 text-arvo-light-secondary dark:text-neutral-400 marker:text-arvo-light-secondary dark:marker:text-neutral-400">
            ...
            />
            <h3 className="text-base font-semibold text-arvo-light-primary dark:text-white mt-8 mb-2">Don&apos;ts:</h3>
            <ul className="mb-6 max-w-2xl list-disc space-y-2 pl-5 text-arvo-light-secondary dark:text-neutral-400 marker:text-arvo-light-secondary dark:marker:text-neutral-400">
            ...
            />
            <p className="mt-6 text-sm text-arvo-light-secondary dark:text-neutral-400 max-w-2xl">
              <strong className="text-arvo-light-primary dark:text-white">Tip:</strong> Always double-check these guidelines for a polished and cohesive icon set.
            </p>
          </div>

          {/* Icons in Figma */}
          <div id="icons-in-figma">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Icons in Figma</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
          ...
          <div id="illustrator-tips">
            <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Illustrator tips</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
            ...
            <div className="border p-4 flex flex-wrap items-center gap-6 dark:border-neutral-700 dark:bg-neutral-800/50" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#F2F2F2' } : undefined}>
              {SIZES.map((s) => (
                <div key={s} className="flex flex-col items-center gap-2">
                  <span className={`o9con o9con-chevron-right arvo-icon-${s} dark:text-white`} style={isLight ? { color: '#010101' } : undefined} aria-hidden />
                  <span className="text-sm font-medium text-arvo-light-primary dark:text-white">{s}px</span>
                  <code className="text-xs font-mono text-arvo-light-secondary dark:text-neutral-400">arvo-icon-{s}</code>
                </div>
              ))}
            </div>
          </div>
      ...
      {activeTab === 'o9con Gallery' && (
        <>
          <section id="display-options">
            <h2 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Display Options</h2>
            <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 mb-4">Customize how icons are displayed in the gallery</p>
              ...
              <div className="flex gap-2">
                {SIZES.map((s) => (
                  <button
                    ...
                    data-arvo-size-selected={selectedSize === s ? '' : undefined}
                    className={`px-4 py-2 text-sm font-medium transition-colors ${
                      selectedSize === s ? 'dark:text-black dark:bg-white' : 'border dark:border-neutral-600 dark:text-neutral-400 hover:text-arvo-light-primary dark:hover:text-white'
                    }`}
                    style={
                      selectedSize === s
          ...
          <section id="o9con-library">
            <div className="mb-4">
              <input
                ...
                className="arvo-doc-search-input w-full max-w-md px-3 py-2 text-sm"
                style={{
            ...
            <h2 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">
              o9con Library
              <span
            ...
            <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 mb-6">
      ...
      {activeTab === 'Accessibility' && (
        <section
          ...
          style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#FFFFFF' } : undefined}
        >
          <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white mb-2">Accessibility Guidelines</h2>
          <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6">Best practices for accessible icon implementation</p>

          <div className="space-y-6">
            <div id="aria-attributes">
              <h3 className="font-semibold text-arvo-light-primary dark:text-white mb-3">ARIA Attributes</h3>
              <ul className="list-disc list-inside space-y-2 text-sm text-arvo-light-secondary dark:text-neutral-400">
                <li>Use <code className="px-1 py-0.5" data-arvo-inline-code>aria-hidden=&quot;true&quot;</code> for decorative icons that don&apos;t convey meaning</li>
                <li>Use <code className="px-1 py-0.5" data-arvo-inline-code>aria-label</code> for icons that have semantic meaning</li>
                <li>Provide alternative text for icons used without accompanying text</li>
              </ul>
            </div>
            <div id="visual-accessibility">
              <h3 className="font-semibold text-arvo-light-primary dark:text-white mb-3">Visual Accessibility</h3>
              <ul className="list-disc list-inside space-y-2 text-sm text-arvo-light-secondary dark:text-neutral-400">
            ...
            <div id="interactive-icons">
              <h3 className="font-semibold text-arvo-light-primary dark:text-white mb-3">Interactive Icons</h3>
              <ul className="list-disc list-inside space-y-2 text-sm text-arvo-light-secondary dark:text-neutral-400">
      ...
      {activeTab === 'Code' && (
        <section className="space-y-8" id="implementation">
          ...
          <p className="text-arvo-light-secondary dark:text-neutral-400">Use the following HTML structure to render o9con icons:</p>

          <CodeBlock
            code={`<!-- Basic icon usage -->
<span class="o9con o9con-chevron-right arvo-icon-24" aria-hidden="true"></span>

<!-- Icon with semantic meaning - include aria-label -->
<button type="button" aria-label="Navigate to next page">
  <span class="o9con o9con-chevron-right arvo-icon-16" aria-hidden="true"></span>
</button>
