...
function TokenRow({ token, hex, primary, isLight }) {
  ...
  return (
    <tr style={{ borderBottom: `1px solid ${rowBorderColor}` }} className="last:border-b-0 group">
      <td className="py-2 px-3 font-mono text-arvo-light-primary dark:text-white">
        {token}
      ...
      <td className="py-2 px-3">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-arvo-light-secondary dark:text-neutral-400" style={isLight ? { color: '#303030' } : undefined}>{hex}</span>
        </div>
      </td>
      ...
      <table className="w-full text-sm">
        <thead>
          ...
          >
            ...
            <th className="py-2 px-3 text-left font-medium text-arvo-light-primary dark:text-white">Hex</th>
            <th className="py-2 px-3 text-left font-medium text-arvo-light-primary dark:text-white w-10" aria-label="Copy" />
          </tr>
        </thead>
        <tbody>
...
function SemanticTokenRow({ row, lightTheme, isLight, semanticSubTab, resolveHex, resolveName }) {
  ...
  const useSurfaceThemeBg =
    ...
    row.token === 'arvo-color-i-inverse' ||
    row.token === 'arvo-color-t-active-inverse' ||
    row.token === 'arvo-color-i-active-inverse'
  const useSurfaceNegativeActiveBg =
    row.token === 'arvo-color-t-white-static' || row.token === 'arvo-color-i-white-static'
  ...
  return (
    <tr style={{ borderBottom: `1px solid ${rowBorderColor}` }} className="last:border-b-0 group">
      <td className="py-2 px-3 font-mono text-arvo-light-primary dark:text-white">{row.token}</td>
        ...
        <div className="flex items-center gap-2">
          {isTextTab ? (
            <div className="shrink-0 min-w-8 h-6 px-1 rounded flex items-center justify-center" style={{ backgroundColor: lightSwatchBg }}>
              <span className="text-base font-medium leading-none arvo-swatch" style={{ ['--arvo-swatch-color']: lightHex, color: 'var(--arvo-swatch-color)' }} title={lightHex} data-arvo-swatch>Ab1@</span>
            </div>
          ) : isIconTab ? (
        ...
        <div className="flex items-center gap-2">
          {isTextTab ? (
            <div className="shrink-0 min-w-8 h-6 px-1 rounded flex items-center justify-center" style={{ backgroundColor: darkSwatchBg }}>
              <span className="text-base font-medium leading-none arvo-swatch" style={{ ['--arvo-swatch-color']: darkHex, color: 'var(--arvo-swatch-color)' }} title={darkHex} data-arvo-swatch>Ab1@</span>
            </div>
          ) : isIconTab ? (
    ...
    >
      <table className="w-full text-sm">
        <thead>
          ...
          >
            <th className="py-2 px-3 text-left font-medium text-arvo-light-primary dark:text-white">Token Name</th>
            <th className="py-2 px-3 text-left font-medium text-arvo-light-primary dark:text-white">Light Mode ({THEME_LABELS[lightTheme]})</th>
            <th className="py-2 px-3 text-left font-medium text-arvo-light-primary dark:text-white">Dark Mode</th>
            <th className="py-2 px-3 text-left font-medium text-arvo-light-primary dark:text-white">Use Case</th>
            <th className="py-2 px-3 text-left font-medium text-arvo-light-primary dark:text-white w-10" aria-label="Copy" />
          </tr>
        </thead>
        <tbody>
...
export default function Colors() {
  ...
  return (
    ...
    <div className="max-w-4xl space-y-8">
      <section>
        <h1 className="group flex items-center gap-2 text-[30px] font-bold text-arvo-light-primary dark:text-white">
          <span className="flex h-8 w-8 items-center justify-center bg-arvo-light-surface dark:bg-neutral-700" data-arvo-avatar data-arvo-avatar-header>
      ...
      {activeTab === 'Overview' && (
        <>
          ...
          <section id="color-system-overview">
            <h2 className="text-xl font-semibold text-arvo-light-primary dark:text-white mb-2">Color System Overview</h2>
            ...
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-8 max-w-2xl leading-relaxed">
              Our color system is built on two foundational layers: <strong className="text-arvo-light-primary dark:text-white">Global Tokens</strong> and <strong className="text-arvo-light-primary dark:text-white">Semantic Tokens</strong>. This approach ensures consistency, maintainability, and flexibility across all design implementations.
            </p>
          ...
          <section id="color-token-levels">
            <h2 className="text-xl font-semibold text-arvo-light-primary dark:text-white mb-4">Color Token Levels</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  level: 2,
                  title: 'Global Colors',
                  desc: 'Mapped to hex codes with meaningful names for easy reference (e.g., arvo-global-o9black, arvo-global-dark-07).',
                  example: 'arvo-global-o9black',
                },
                {
                  level: 3,
                ...
                },
                {
                  ...
                  example: 'arvo-color-t-form-value',
                },
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-semibold text-arvo-light-primary dark:text-white mb-1">{title}</h3>
                    <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 mb-2">{desc}</p>
          ...
          <section id="referencing-flow">
            <h2 className="text-xl font-semibold text-arvo-light-primary dark:text-white mb-4">Referencing Flow</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
            ...
            <div className="border dark:border-neutral-700 p-6 shadow-sm" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#F2F2F2' } : undefined}>
              <div className="flex flex-col md:flex-row md:items-center md:gap-4">
                <div className="flex flex-col items-center gap-2 p-4 border dark:border-neutral-600 rounded" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#FFFFFF' } : undefined}>
                  <span className="text-xs font-medium text-arvo-light-secondary dark:text-neutral-400">Level 1 · Hex</span>
                  <div className="h-10 w-10 rounded border dark:border-neutral-600" style={{ backgroundColor: '#010101' }} />
                  <code className="text-sm font-mono text-arvo-light-primary dark:text-white">#010101</code>
                </div>
                <span className="hidden md:block text-arvo-light-secondary dark:text-neutral-500">→</span>
                <div className="flex flex-col items-center gap-2 p-4 border dark:border-neutral-600 rounded" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#FFFFFF' } : undefined}>
                  <span className="text-xs font-medium text-arvo-light-secondary dark:text-neutral-400">Level 2 · Global</span>
                  <div className="h-10 w-10 rounded border dark:border-neutral-600" style={{ backgroundColor: '#010101' }} />
                  <code className="text-sm font-mono text-arvo-light-primary dark:text-white">arvo-global-o9black</code>
                </div>
                <span className="hidden md:block text-arvo-light-secondary dark:text-neutral-500">→</span>
                <div className="flex flex-col items-center gap-2 p-4 border dark:border-neutral-600 rounded" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#FFFFFF' } : undefined}>
                  <span className="text-xs font-medium text-arvo-light-secondary dark:text-neutral-400">Level 3 · Semantic</span>
                  <div className="h-10 w-10 rounded border dark:border-neutral-600" style={{ backgroundColor: '#010101' }} />
                  <code className="text-sm font-mono text-arvo-light-primary dark:text-white">arvo-color-t-theme</code>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="naming-convention">
            <h2 className="text-xl font-semibold text-arvo-light-primary dark:text-white mb-4">Naming Convention</h2>
            ...
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
              Example: <code className="px-1.5 py-0.5 text-sm font-mono dark:bg-neutral-800 text-arvo-light-primary dark:text-white" style={isLight ? { backgroundColor: '#E5E5E5', color: '#010101' } : undefined}>arvo-color-s-negative</code>
            </p>
              ...
              <table className="w-full text-sm border dark:border-neutral-700" style={isLight ? { borderColor: '#E5E5E5' } : undefined}>
                <thead>
                  <tr style={isLight ? { backgroundColor: '#F2F2F2', borderColor: '#E5E5E5' } : undefined} className="border-b dark:border-neutral-700 dark:bg-neutral-800/50">
                    <th className="py-3 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Part</th>
                    <th className="py-3 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Definition</th>
                    <th className="py-3 px-4 text-left font-medium text-arvo-light-primary dark:text-white">Example</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ['system', 'Prefix representing the Arvo Design System', 'arvo'],
                    ...
                    <tr key={part} className="border-b dark:border-neutral-700/50">
                      <td className="py-3 px-4 font-mono text-arvo-light-primary dark:text-white">{part}</td>
                      <td className="py-3 px-4 text-arvo-light-secondary dark:text-neutral-400">{def}</td>
                      <td className="py-3 px-4 font-mono text-arvo-light-secondary dark:text-neutral-400">{ex}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="mt-6">
              <h3 className="text-sm font-semibold text-arvo-light-primary dark:text-white mb-3">Variant codes</h3>
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <div key={code} className="flex gap-3 p-3 border dark:border-neutral-700" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#FFFFFF' } : undefined}>
                    <code className="shrink-0 font-mono text-sm font-semibold text-arvo-light-primary dark:text-white">({code})</code>
                    <div>
                      <span className="font-medium text-arvo-light-primary dark:text-white">{name}</span>
          ...
          <section id="types-of-variables">
            <h2 className="text-xl font-semibold text-arvo-light-primary dark:text-white mb-4">Types of Variables & Their Behavior</h2>
            <p className="text-arvo-light-secondary dark:text-neutral-400 mb-6 max-w-2xl">
              ...
              {[
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-semibold text-arvo-light-primary dark:text-white">{type}</h3>
                  ...
                  <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">{desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section id="usage-guidelines">
            <h2 className="text-xl font-semibold text-arvo-light-primary dark:text-white mb-4">Usage Guidelines</h2>
        ...
        <>
          ...
          <section id="brand-palettes" className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {BRAND_PALETTES.map(({ name, palette }) => (
              <div key={name} className="border dark:border-neutral-700 overflow-hidden" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#F2F2F2' } : undefined}>
                <div className="border-b dark:border-neutral-700 px-4 py-3 dark:bg-neutral-800/50" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: 'transparent' } : undefined}>
                  <h3 className="text-sm font-semibold text-arvo-light-primary dark:text-white">{name}</h3>
                </div>
                <div>
            ...
            <div className="border dark:border-neutral-700 overflow-hidden sm:col-span-2 lg:col-span-1" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#F2F2F2' } : undefined}>
              <div className="border-b dark:border-neutral-700 px-4 py-3 dark:bg-neutral-800/50" style={isLight ? { borderColor: '#E5E5E5', backgroundColor: 'transparent' } : undefined}>
                <h3 className="text-sm font-semibold text-arvo-light-primary dark:text-white">Neutrals</h3>
              </div>
              <div>
      ...
      {activeTab === 'Global Tokens' && (
        <section className="space-y-10">
          ...
          <div id="global-neutral-colors">
            <h2 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Neutral Colors</h2>
            <p className="text-lg text-arvo-light-secondary dark:text-neutral-400 mb-4 max-w-2xl" style={isLight ? { color: '#303030' } : undefined}>
          ...
          <div id="global-o9-theme">
            <h2 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">o9 Theme</h2>
          ...
          <div id="global-dark-mode">
            <h2 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Dark Mode Theme</h2>
            <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 mb-4" style={isLight ? { color: '#303030' } : undefined}>
          ...
          <div id="global-secondary-themes">
            <h2 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Secondary Themes</h2>
            <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 mb-4" style={isLight ? { color: '#303030' } : undefined}>
              Forest Green, Onyx Black, Midnight Indigo, and Sky Blue.
            </p>
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                <h3 className="text-sm font-medium text-arvo-light-primary dark:text-white mb-3">Forest Green</h3>
                <TokenTable tokens={FORESTGREEN_TOKENS} isLight={isLight} />
              </div>
              <div>
                <h3 className="text-sm font-medium text-arvo-light-primary dark:text-white mb-3">Onyx Black</h3>
                <TokenTable tokens={ONYXBLACK_TOKENS} isLight={isLight} />
              </div>
              <div>
                <h3 className="text-sm font-medium text-arvo-light-primary dark:text-white mb-3">Midnight Indigo</h3>
                <TokenTable tokens={MIDNIGHTINDIGO_TOKENS} isLight={isLight} />
              </div>
              <div>
                <h3 className="text-sm font-medium text-arvo-light-primary dark:text-white mb-3">Sky Blue</h3>
          ...
          <div id="global-feedback-colors">
            <h2 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Feedback Colors</h2>
            <p className="text-lg text-arvo-light-secondary dark:text-neutral-400 mb-4 max-w-2xl" style={isLight ? { color: '#303030' } : undefined}>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                <h3 className="text-sm font-medium text-arvo-light-primary dark:text-white mb-3">Bluish</h3>
                <TokenTable tokens={FEEDBACK_BLUISH} isLight={isLight} />
              </div>
              <div>
                <h3 className="text-sm font-medium text-arvo-light-primary dark:text-white mb-3">Greenish</h3>
                <TokenTable tokens={FEEDBACK_GREENISH} isLight={isLight} />
              </div>
              <div>
                <h3 className="text-sm font-medium text-arvo-light-primary dark:text-white mb-3">Redish</h3>
          ...
          <div id="global-utility-colors">
            <h2 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Utility Colors</h2>
            <p className="text-sm text-arvo-light-secondary dark:text-neutral-400 mb-4" style={isLight ? { color: '#303030' } : undefined}>
      ...
      {activeTab === 'Semantic Tokens' && (
        <section id="semantic-tokens" className="space-y-6">
          ...
          {/* Theme switcher - reuse Display Options button group styling (data-arvo-size-selected) */}
            ...
            <div className="flex gap-2">
              {LIGHT_THEMES.map((t) => (
                <button
                  ...
                  data-arvo-size-selected={lightTheme === t ? '' : undefined}
                  className={`px-4 py-2 text-sm font-medium transition-colors ${
                    lightTheme === t ? 'dark:text-black dark:bg-white' : 'border dark:border-neutral-600 dark:text-neutral-400 hover:text-arvo-light-primary dark:hover:text-white'
                  }`}
                  style={
                    lightTheme === t
          ...
          {/* Semantic sub-tabs - reuse existing tabs (data-arvo-tabs) */}
          <div
            role="tablist"
            className="flex gap-6 border-b border-arvo-light-border dark:border-neutral-700"
            data-arvo-tabs
