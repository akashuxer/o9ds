    ...
    <PageWithToc sections={onThisPageSections}>
      <div className="max-w-4xl space-y-10">
        ...
        <section id="symbol-usage" className="space-y-4">
          <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Usage</h2>
          <p className="text-o9ds-light-secondary dark:text-neutral-400">File Type Icons can be used in multiple contexts:</p>
          <ul className="list-disc list-inside space-y-2 text-o9ds-light-secondary dark:text-neutral-400">
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">File preview / attachments</strong> — Helps users understand the type of uploaded or available files at a glance.
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Upload component</strong> — Displays file type immediately after upload, giving users confirmation and clarity.
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Standalone usage</strong> — Can be used independently in lists, tables, cards, or file explorers wherever file representation is needed.
            </li>
          </ul>
        </section>

        <section id="symbol-behavior" className="space-y-4">
          <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Behavior &amp; principles</h2>
          <ul className="space-y-3 text-o9ds-light-secondary dark:text-neutral-400">
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Instant recognition</strong> — Each icon uses a combination of color and file extension label so users can identify file types quickly.
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Consistency</strong> — Icons maintain a uniform shape, structure, and styling across all file types.
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Clarity over decoration</strong> — The design is intentionally minimal to prioritize usability over visual complexity.
            </li>
          </ul>
        </section>

        <section id="symbol-size" className="space-y-4">
          <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Size &amp; responsiveness</h2>
          <ul className="list-disc list-inside space-y-2 text-o9ds-light-secondary dark:text-neutral-400">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-o9ds-light-secondary dark:text-neutral-400">
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">24px</strong> — default
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">32px</strong> — alternate fixed size
            </li>
          </ul>
          <p className="text-sm text-o9ds-light-secondary dark:text-neutral-400">Use only these two sizes; do not stretch to arbitrary dimensions.</p>
        </section>

        <section id="symbol-variants" className="space-y-4">
          <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Variants</h2>
          ...
          <p className="text-o9ds-light-secondary dark:text-neutral-400">Examples include:</p>
          <ul className="list-disc list-inside space-y-2 text-o9ds-light-secondary dark:text-neutral-400">
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Document:</strong> PDF, DOC, DOCX, TXT, PPT
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Image:</strong> PNG, JPEG, IMG, SVG
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Data:</strong> CSV, XLSX, JSON, XML
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Compressed:</strong> ZIP, RAR
            </li>
            <li>
              <strong className="text-o9ds-light-primary dark:text-white">Web:</strong> HTML
            </li>
          </ul>
        </section>

        <section id="symbol-dos" className="space-y-4">
          <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Do&apos;s and Don&apos;ts</h2>
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            >
              <h3 className="font-semibold text-o9ds-light-primary dark:text-white mb-3">Do&apos;s</h3>
            ...
            <div
              ...
              style={isLight ? { borderColor: '#E5E5E5', backgroundColor: '#FFFFFF' } : undefined}
            >
              <h3 className="font-semibold text-o9ds-light-primary dark:text-white mb-3">Don&apos;ts</h3>
              <ul className="list-disc list-inside space-y-2 text-sm text-o9ds-light-secondary dark:text-neutral-400">
        ...
        <section id="symbol-gallery" className="space-y-6">
          <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Symbol Gallery</h2>
          <p className="text-sm text-o9ds-light-secondary dark:text-neutral-400">
            Assets currently use the same SVG for light and dark themes. When dark-specific assets are added, they can be served from <code className="px-1 py-0.5" data-o9ds-inline-code>/symbol/dark/</code> without changing the layout here.
          </p>
            ...
            <div className="flex gap-2">
              {SYMBOL_SIZES.map((s) => (
                <button
                  ...
                  data-o9ds-size-selected={gallerySize === s ? '' : undefined}
        ...
        >
          <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white mb-3">Future</h2>
          <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed">
        ...
        <section id="symbol-code" className="space-y-6">
          ...
          <p className="text-o9ds-light-secondary dark:text-neutral-400">
            Render at <strong className="text-o9ds-light-primary dark:text-white">24×24px</strong> (default) or{' '}
            <strong className="text-o9ds-light-primary dark:text-white">32×32px</strong> only. Use the published SVG path; set width and height explicitly—do not scale with arbitrary CSS values.
          </p>
          <CodeBlock
          ...
          />
          <div>
            <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white mb-3">Size tokens</h3>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 mb-4">SCSS variables for the two symbol sizes:</p>
