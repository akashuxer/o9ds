...
const cards = [
  ...
  { title: 'Foundations', desc: 'Tokens, colors, typography, spacing', path: '/foundations', icon: 'foundations' },
  { title: 'Assets', desc: 'Icons and illustrations', path: '/icons', icon: 'assets' },
  { title: 'Components', desc: 'Buttons, inputs, navigation, and more', path: '/components', icon: 'components' },
