  ...
  return (
    ...
    >
      <section id="a11y-intro" className="space-y-4 scroll-mt-24">
        ...
        <blockquote className="border-l-4 border-arvo-light-primary dark:border-neutral-500 pl-4 py-1 my-4 text-arvo-light-secondary dark:text-neutral-300 italic">
          Disability is not the problem. Barriers are the problem.
        </blockquote>
      </section>

      <section id="a11y-why" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Why accessibility matters</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
      ...
      <section id="a11y-curb-cut" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">The curb-cut effect</h2>
        <figure className="border border-arvo-light-border dark:border-neutral-700 p-4 md:p-6 bg-arvo-light-surface dark:bg-neutral-900/40">
          <ExpandableDocImage
        ...
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
          This is often called the <strong className="text-arvo-light-primary dark:text-white">curb-cut effect</strong>: solutions designed for accessibility end up benefiting a much wider group of users.
        </p>
      </section>
      ...
      <section id="a11y-baseline" className="space-y-4 scroll-mt-24">
        ...
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
          Our design system targets <strong className="text-arvo-light-primary dark:text-white">WCAG 2.2 AA</strong> as the baseline for accessible product experiences.
        </p>
        <p className="text-arvo-light-secondary dark:text-neutral-400">Our accessibility expectations include:</p>
        <ul className="list-disc list-inside space-y-2 text-arvo-light-secondary dark:text-neutral-400">
      ...
      <section id="a11y-shared" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Accessibility is a shared responsibility</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
          Accessibility is not a single feature or final QA step.
        </p>
        <p className="text-arvo-light-secondary dark:text-neutral-400">It must be considered across:</p>
        <ul className="list-disc list-inside space-y-2 text-arvo-light-secondary dark:text-neutral-400">
          <li>design</li>
          <li>content</li>
          <li>engineering</li>
      ...
      <section id="a11y-principles" className="space-y-6 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Accessibility principles we follow</h2>
        <ol className="list-decimal list-inside space-y-4 text-arvo-light-secondary dark:text-neutral-400">
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Use semantic HTML first</strong> — Prefer native elements such as{' '}
            <code className="px-1 py-0.5 text-sm" data-arvo-inline-code>button</code>,{' '}
            <code className="px-1 py-0.5 text-sm" data-arvo-inline-code>a</code>,{' '}
            <code className="px-1 py-0.5 text-sm" data-arvo-inline-code>input</code>,{' '}
            <code className="px-1 py-0.5 text-sm" data-arvo-inline-code>select</code>,{' '}
            <code className="px-1 py-0.5 text-sm" data-arvo-inline-code>textarea</code>,{' '}
            <code className="px-1 py-0.5 text-sm" data-arvo-inline-code>table</code>, and heading tags before adding ARIA.
          </li>
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Make all functionality available by keyboard</strong> — If something can be done with a mouse, it must also be operable with a keyboard.
          </li>
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Preserve clear focus</strong> — Users must always know where keyboard focus is, where it moves, and how to return.
          </li>
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Expose meaning to assistive technology</strong> — Interactive elements must expose an accessible name, role, state, and value when relevant.
          </li>
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Do not rely on color alone</strong> — Color can support meaning, but it must not be the only way information is conveyed.
          </li>
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Keep behavior predictable</strong> — Components should behave consistently across the product so users do not need to relearn interactions.
          </li>
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Design for recovery</strong> — Required fields, validation, disabled actions, and dynamic updates must be understandable and recoverable.
          </li>
        </ol>
      </section>

      <section id="a11y-next" className="space-y-4 scroll-mt-24 border border-arvo-light-border dark:border-neutral-700 p-6 md:p-8">
