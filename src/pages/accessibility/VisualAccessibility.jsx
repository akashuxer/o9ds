  ...
  return (
    ...
    >
      ...
      <section id="a11y-vis-contrast" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Color contrast</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">Minimum guidance (WCAG 2.2 AA):</p>
        ...
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm font-medium">Common failures:</p>
        <ul className="list-disc list-inside space-y-1 text-arvo-light-secondary dark:text-neutral-400 text-sm">
      ...
      <section id="a11y-vis-color-alone" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Do not use color alone</h2>
      ...
      <section id="a11y-vis-focus" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Focus visibility</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">
          Focused elements must be visually distinct: use design tokens for focus rings, ensure contrast in light and dark themes, do not remove outlines without an accessible replacement, and prefer <code className="px-1" data-arvo-inline-code>:focus-visible</code> where appropriate.
        </p>
      </section>

      <section id="a11y-vis-zoom" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Zoom and reflow</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">
      ...
      <section id="a11y-vis-layout" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Layout guidance for zoom</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">
          Prefer flexible layouts and relative units (<code className="px-1" data-arvo-inline-code>rem</code>, <code className="px-1" data-arvo-inline-code>%</code>), responsive containers, min/max constraints, and wrapping. Avoid rigid pixel-only layouts that break under zoom.
        </p>
      </section>

      <section id="a11y-vis-images" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Images</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">Meaningful images: descriptive <code className="px-1" data-arvo-inline-code>alt</code> text. Decorative images: empty <code className="px-1" data-arvo-inline-code>alt</code>.</p>
        <CodeBlock
...
<img src="/decorative-divider.svg" alt="" />`}
        ...
        />
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm mt-4">
          Decorative icons inside buttons: <code className="px-1" data-arvo-inline-code>aria-hidden=&quot;true&quot;</code> on the SVG when visible text provides the name; icon-only buttons need <code className="px-1" data-arvo-inline-code>aria-label</code>.
        </p>
      </section>

      <section id="a11y-vis-dataviz" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Data visualization</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">
      ...
      <section id="a11y-vis-theme" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Theme considerations</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">
