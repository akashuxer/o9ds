...
export default function ScreenReaderAndAria() {
      ...
      {activeTab === 'Overview' && (
        <div className="space-y-10 pt-2" role="tabpanel" aria-label="Overview">
          <section id="a11y-sem-tree" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Accessibility Tree</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed">
              Browsers derive an <strong className="text-o9ds-light-primary dark:text-white">accessibility tree</strong> from the DOM together with each element’s exposed accessibility properties. Assistive technologies use that tree—not the visual paint order—to learn names, roles, states, descriptions, focus behavior, and relationships to nearby content.
            </p>
            <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">How the DOM and accessibility tree relate</h3>
            ...
            <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">What the tree exposes</h3>
            <figure className="border border-o9ds-light-border dark:border-neutral-700 p-4 md:p-6 bg-o9ds-light-surface dark:bg-neutral-900/40">
              <ExpandableDocImage
            ...
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
              ...
              <strong className="text-o9ds-light-primary dark:text-white">contrast</strong> or visibility-related signals where the browser makes them available. If this information is missing or wrong, users get the wrong label, state, or context—not just a cosmetic bug.
            </p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Commonly relevant fields include:</p>
            <ul className="list-disc list-inside space-y-2 text-o9ds-light-secondary dark:text-neutral-400 text-sm">
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">Roles</strong> — what kind of object it is (link, button, text field, region, and so on).
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">Names</strong> — the accessible name users hear or read for the control.
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">States</strong> — current conditions such as checked, disabled, or busy.
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">Properties</strong> — stable or semi-stable attributes such as expanded, haspopup, or level.
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">Description</strong> — supplementary text (often from <code className="px-1" data-o9ds-inline-code>aria-describedby</code> or similar) beyond the primary name.
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">Contrast</strong> — where exposed, whether text/graphics meet contrast expectations against their background (often emphasized in developer tooling).
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">Keyboard focusable</strong> — whether the element can receive keyboard focus and participate in focus order.
              </li>
            </ul>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
          ...
          <section id="a11y-semantic-coding" className="space-y-6 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Semantic coding vs non-semantic coding</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">Semantic</strong> markup uses elements for what they are meant for (for example <code className="px-1" data-o9ds-inline-code>button</code> for actions).{' '}
              <strong className="text-o9ds-light-primary dark:text-white">Non-semantic</strong> markup (often a <code className="px-1" data-o9ds-inline-code>div</code> or <code className="px-1" data-o9ds-inline-code>span</code> with click handlers) may look right visually but often lacks roles, keyboard support, and names in the accessibility tree until you add them manually.
            </p>
            <div className="space-y-3">
              <CodeBlock code={`<div onclick="saveChanges()">Save</div>`} label="Non-semantic: div as fake button" />
              <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">This is visually clickable but not accessible by default.</p>
            </div>
            <div className="space-y-3">
          ...
          <section id="a11y-aria" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">ARIA: what it is</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed">
            ...
            <blockquote className="border-l-4 border-o9ds-light-primary dark:border-neutral-500 pl-4 italic text-o9ds-light-secondary dark:text-neutral-300">
              No ARIA is better than bad ARIA.
            </blockquote>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Use ARIA to enhance semantics, not to replace correct HTML unnecessarily.</p>
          </section>

          <section id="a11y-roles" className="space-y-8 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Roles, states, and properties</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">Roles (common roles)</h3>
              ...
              <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">
                Prefer a native <code className="px-1" data-o9ds-inline-code>button</code> when possible; use explicit roles only when HTML cannot represent the control.
              </p>
            </div>
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">States (common states)</h3>
              ...
              />
              <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">
                When the panel opens, set <code className="px-1" data-o9ds-inline-code>aria-expanded</code> to <code className="px-1" data-o9ds-inline-code>true</code>.
              </p>
            </div>
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">Properties (common properties)</h3>
  ...
  <span aria-hidden="true">×</span>
              ...
              />
              <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">
                Use <code className="px-1" data-o9ds-inline-code>aria-label</code> when there is no visible text name—often icon-only buttons or a single control in a toolbar—so the accessible name is not left empty.
              </p>
            </div>
          </section>

          <section id="a11y-sr-modes" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Screen reader modes (Browser Mode vs Focus Mode)</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
              Assistive technology has two modes of operation: <strong className="text-o9ds-light-primary dark:text-white">browse mode</strong> for navigating and reading the page, and <strong className="text-o9ds-light-primary dark:text-white">focus mode</strong> (or forms mode) for interacting with controls such as form fields and buttons. Users can toggle between the two modes using <kbd className="px-1 font-mono text-xs border border-o9ds-light-border dark:border-neutral-600 bg-o9ds-light-surface dark:bg-neutral-800">Insert</kbd> +{' '}
              <kbd className="px-1 font-mono text-xs border border-o9ds-light-border dark:border-neutral-600 bg-o9ds-light-surface dark:bg-neutral-800">Space</kbd> on many screen readers (exact shortcuts depend on the product and platform).
            </p>
            <figure className="border border-o9ds-light-border dark:border-neutral-700 p-4 md:p-6 bg-o9ds-light-surface dark:bg-neutral-900/40">
              <ExpandableDocImage
      ...
      {activeTab === 'Labels' && (
        <div className="space-y-10 pt-2" role="tabpanel" aria-label="Labels">
          <section id="a11y-names" className="space-y-6 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Accessible names</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
              Every interactive element needs one clear accessible name. When several techniques apply, prefer this order: a <strong className="text-o9ds-light-primary dark:text-white">visible text label</strong> tied with <code className="px-1" data-o9ds-inline-code>for</code>/<code className="px-1" data-o9ds-inline-code>id</code>, then <code className="px-1" data-o9ds-inline-code>aria-labelledby</code> pointing at visible text elsewhere, then <code className="px-1" data-o9ds-inline-code>aria-label</code> when there is no suitable visible string.
            </p>
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">
                Visible label with <code className="px-1 text-base" data-o9ds-inline-code>for</code> and <code className="px-1 text-base" data-o9ds-inline-code>id</code>
              </h3>
              <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
                Use this for standard form controls whenever you can. The <code className="px-1" data-o9ds-inline-code>label</code> text becomes the accessible name, clicking the label moves focus to the control, and you avoid maintaining the same string in two attributes. In React, use <code className="px-1" data-o9ds-inline-code>htmlFor</code> instead of <code className="px-1" data-o9ds-inline-code>for</code>.
              </p>
              <CodeBlock
...
<input id="username" type="text" autocomplete="username" />`}
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">
                <code className="px-1 text-base" data-o9ds-inline-code>aria-labelledby</code>
              </h3>
              <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
...
<button type="button" aria-labelledby="payment-heading">
  Edit
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">
                <code className="px-1 text-base" data-o9ds-inline-code>aria-label</code>
              </h3>
              <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
                Use when there is no appropriate visible label string—icon-only buttons, a single control in a toolbar, or when visible text would be redundant for sighted users but you still need a short phrase for assistive technology. Keep labels concise; do not repeat the same text as a visible <code className="px-1" data-o9ds-inline-code>label</code> or you risk double announcements.
              </p>
              <CodeBlock code={`<button type="button" aria-label="Close">×</button>`} label="Icon-only control" />
            </div>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">
              Avoid duplicate naming (for example a visible <code className="px-1" data-o9ds-inline-code>label</code> plus the same string in <code className="px-1" data-o9ds-inline-code>aria-label</code>)—screen readers may announce it twice.
            </p>
          </section>

          <section id="a11y-sronly" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Screen-reader-only text</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
              Use proper CSS for supplementary copy that should be read by assistive technologies but not shown on screen. Do not use <code className="px-1" data-o9ds-inline-code>display: none</code> or <code className="px-1" data-o9ds-inline-code>visibility: hidden</code> for that purpose—they remove the content from the accessibility tree. Use the <code className="px-1" data-o9ds-inline-code>.o9-msg-sr-only</code> class: it visually hides the element while keeping it available to screen readers, typically by clipping to a 1×1 pixel and positioning off-screen.
            </p>
            <CodeBlock
              code={`.o9-msg-sr-only {
  position: absolute;
  ...
  border: 0;
              ...
              label="o9ds screen-reader-only utility"
            />
            <CodeBlock
  ...
  <span class="o9-msg-sr-only">Close dialog</span>
          ...
          <section id="a11y-describedby" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">When to use aria-describedby</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">
...
<p id="emailHelp">Use your work email address.</p>`}
          ...
          <section id="a11y-form-date" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Date and time formats</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
          ...
          <section id="a11y-form-required" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Required fields</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              Communicate required state visually and programmatically; use native <code className="px-1" data-o9ds-inline-code>required</code> when appropriate; do not rely on color alone.
            </p>
            <CodeBlock
...
<input id="email" type="email" required />`}
          ...
          <section id="a11y-form-errors" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Error handling principles</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              Errors should be <strong className="text-o9ds-light-primary dark:text-white">timely</strong>, <strong className="text-o9ds-light-primary dark:text-white">specific</strong>, <strong className="text-o9ds-light-primary dark:text-white">actionable</strong>, programmatically and visually <strong className="text-o9ds-light-primary dark:text-white">associated</strong> with the relevant field, and easy to <strong className="text-o9ds-light-primary dark:text-white">recover</strong> from.
            </p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">Timing:</strong> validate on blur for simple format checks when it helps; validate on submit when rules depend on the whole form or when early validation would be noisy; hybrid patterns are common. When a value is invalid, set <code className="px-1" data-o9ds-inline-code>aria-invalid=&quot;true&quot;</code> and associate the error message with the control (for example via <code className="px-1" data-o9ds-inline-code>aria-describedby</code> pointing at the error element id).
            </p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              When submit fails, move keyboard focus to the first invalid field—see <strong className="text-o9ds-light-primary dark:text-white">Keyboard and focus</strong> → <em>Forms: focus first error</em>.
            </p>
            <CodeBlock
...
<p id="workEmailError">Enter a valid work email address.</p>`}
          ...
          <section id="a11y-form-error-clarity" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Clear errors, required fields, and association</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              Unclear error messages and missing identification of mandatory fields create frustration for everyone and can <strong className="text-o9ds-light-primary dark:text-white">block task completion</strong> for people using assistive technologies. If users cannot tell which field failed or what to change, they may abandon the flow.
            </p>
            <ul className="list-disc list-inside space-y-2 text-sm text-o9ds-light-secondary dark:text-neutral-400">
              <li>Expose <strong className="text-o9ds-light-primary dark:text-white">required</strong> state in the label text and programmatically (native <code className="px-1" data-o9ds-inline-code>required</code> or equivalent), not only with color.</li>
              <li>Ensure each error message is <strong className="text-o9ds-light-primary dark:text-white">programmatically tied</strong> to its field so screen readers hear the error in context when the field is focused.</li>
          ...
          <section id="a11y-form-disabled" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Disabled states</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              Native <code className="px-1" data-o9ds-inline-code>disabled</code> when the control should be fully unavailable. <code className="px-1" data-o9ds-inline-code>aria-disabled=&quot;true&quot;</code> when it should stay discoverable but not operable in managed widgets.
            </p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
          ...
          <section id="a11y-form-title" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Tooltips vs HTML title</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              Do not rely on the HTML <code className="px-1" data-o9ds-inline-code>title</code> attribute for important information—it is mouse-biased, unreliable for keyboard users, and inconsistently announced. Surface critical instructions visibly and programmatically.
            </p>
          </section>

          <section id="a11y-form-ambiguous" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Avoid ambiguous labels to reduce confusion</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
          ...
          <section id="a11y-group" className="space-y-6 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Grouping related controls</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
              Related inputs should share a single programmatic group name so screen readers announce the set before each control. In o9ds we group with <code className="px-1" data-o9ds-inline-code>role="group"</code> and <code className="px-1" data-o9ds-inline-code>aria-label</code> or <code className="px-1" data-o9ds-inline-code>aria-labelledby</code> instead of <code className="px-1" data-o9ds-inline-code>fieldset</code>/<code className="px-1" data-o9ds-inline-code>legend</code>.
            </p>
            <CodeBlock
      ...
      {activeTab === 'Live regions' && (
        <div className="space-y-10 pt-2" role="tabpanel" aria-label="Live regions">
          <section id="a11y-live-intro" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Live regions</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
              Screen readers expose changes to the accessibility tree. When text updates without moving focus—save confirmations, search result counts, new chat messages, validation summaries—use a <strong className="text-o9ds-light-primary dark:text-white">live region</strong> so assistive technologies can announce the change. Choose politeness (polite vs assertive) and roles (<code className="px-1" data-o9ds-inline-code>status</code>, <code className="px-1" data-o9ds-inline-code>alert</code>, <code className="px-1" data-o9ds-inline-code>log</code>) to match urgency and context.
            </p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">Navigation vs announcement:</strong> if the user must act on an error immediately, prefer moving <strong className="text-o9ds-light-primary dark:text-white">focus</strong> to the field or summary first; use live regions when focus should stay put or when the update is supplementary.
            </p>
          </section>

          <section id="a11y-live-when" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">When to use live regions</h2>
            <ul className="list-disc list-inside space-y-2 text-o9ds-light-secondary dark:text-neutral-400 text-sm">
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">Polite</strong> — non-urgent status (saved, filtered, loading finished, cart updated).
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">Assertive</strong> — time-sensitive problems (session ending, payment failed) where delay would harm the user.
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">role=&quot;status&quot;</strong> — lightweight inline status (syncing, last saved).
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">role=&quot;alert&quot;</strong> — critical messages that must interrupt (often with assertive behavior); prefer focus management for form errors when possible.
              </li>
              <li>
                <strong className="text-o9ds-light-primary dark:text-white">role=&quot;log&quot;</strong> — append-only streams such as chat or activity feeds where new entries arrive at the end.
              </li>
            </ul>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              Elements without an explicit live region behave as <code className="px-1" data-o9ds-inline-code>aria-live=&quot;off&quot;</code> (implicit): static content is not re-announced unless focus moves there.
            </p>
          </section>

          <section id="a11y-live-polite" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">
              <code className="text-base px-1" data-o9ds-inline-code>aria-live=&quot;polite&quot;</code>
            </h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">When to use:</strong> routine updates that can wait until the screen reader finishes its current phrase—autosave, result counts, soft validation hints that are not blocking.
            </p>
            <CodeBlock
...
<!-- After save: textContent = "Saved." -->`}
          ...
          <section id="a11y-live-assertive" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">
              <code className="text-base px-1" data-o9ds-inline-code>aria-live=&quot;assertive&quot;</code>
            </h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">When to use:</strong> urgent interruptions—session timeout warnings, failed payment, destructive action could not complete. Use sparingly; overuse trains users to ignore announcements.
            </p>
            <CodeBlock
  ...
  Connection lost. Reconnecting…
          ...
          <section id="a11y-live-status" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">
              <code className="text-base px-1" data-o9ds-inline-code>role=&quot;status&quot;</code>
            </h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">When to use:</strong> short, non-blocking status text where <code className="px-1" data-o9ds-inline-code>role=&quot;status&quot;</code> matches the meaning (implicit polite live region). Pair with visible text or icons for sighted users.
            </p>
  ...
  <span aria-hidden="true">●</span> Live updating
          ...
          <section id="a11y-live-alert" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">
              <code className="text-base px-1" data-o9ds-inline-code>role=&quot;alert&quot;</code>
            </h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">When to use:</strong> important errors or blockers announced without requiring focus—often behaves like assertive. For in-form validation, moving focus to the first invalid field is usually better; use <code className="px-1" data-o9ds-inline-code>alert</code> for page-level or async failures where focus cannot move.
            </p>
            <CodeBlock
          ...
          <section id="a11y-live-log" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">
              <code className="text-base px-1" data-o9ds-inline-code>role=&quot;log&quot;</code>
            </h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">When to use:</strong> sequential, append-only content—chat transcripts, audit trails, live comment threads. New nodes are typically announced without reading the whole history; combine with <code className="px-1" data-o9ds-inline-code>aria-live=&quot;polite&quot;</code> when you need explicit control.
            </p>
            <CodeBlock
  ...
  <p><time>10:03</time> Support: Hi, how can we help?</p>
          ...
          <section id="a11y-live-attrs" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">
              <code className="px-1" data-o9ds-inline-code>aria-atomic</code> and <code className="px-1" data-o9ds-inline-code>aria-relevant</code>
            </h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">aria-atomic=&quot;true&quot;</strong> — announce the entire region when any part changes (good when partial updates would sound meaningless alone).
            </p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              <strong className="text-o9ds-light-primary dark:text-white">aria-relevant</strong> — refine what counts as a change: <code className="px-1" data-o9ds-inline-code>additions</code> for new list items, <code className="px-1" data-o9ds-inline-code>text</code> for text changes, or combinations. Helps noisy lists stay understandable.
            </p>
          </section>
        </div>
      )}
      ...
      {activeTab === 'Heading & page title' && (
        <div className="space-y-10 pt-2" role="tabpanel" aria-label="Heading and page title">
          <section id="a11y-heading-intro" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Maintaining proper heading hierarchy</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
            ...
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
              <strong className="text-o9ds-light-primary dark:text-white">No skipped levels:</strong> Maintain a nested structure (H1 → H2 → H3), avoiding jumps like H2 to H4, which breaks outline navigation for screen readers.
            </p>
            <figure className="border border-o9ds-light-border dark:border-neutral-700 p-4 md:p-6 bg-o9ds-light-surface dark:bg-neutral-900/40">
              <ExpandableDocImage
            ...
            <div className="space-y-4 pt-2">
              <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">Examples (headings only)</h3>
              <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
...
<h3>Column header</h3>`}
          ...
          <section id="a11y-headings" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Headings must be semantic</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed text-sm">
              Do not style plain text to look like a heading without conveying heading semantics. Use one logical <code className="px-1" data-o9ds-inline-code>h1</code> per page or view where appropriate; do not skip levels without reason. Prefer real <code className="px-1" data-o9ds-inline-code>h1</code>–<code className="px-1" data-o9ds-inline-code>h6</code> so the document outline and screen reader shortcuts stay correct.
            </p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              If you cannot use a native heading element—for example a legacy wrapper forbids it—use <code className="px-1" data-o9ds-inline-code>role=&quot;heading&quot;</code> with <code className="px-1" data-o9ds-inline-code>aria-level</code> set to the equivalent level (1–6). This is a fallback, not the default.
            </p>
            <CodeBlock
...
<section>
  ...
  <p>Update your profile.</p>
          ...
          <section id="a11y-page-title" className="space-y-4 scroll-mt-24">
            <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Page titles</h2>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm leading-relaxed">
              Each page or view should have a meaningful <code className="px-1" data-o9ds-inline-code>document.title</code> (and where applicable, a unique route title) reflecting content and context. That helps navigation, history, screen reader orientation when switching tabs, and task recovery.
            </p>
          </section>
        </div>
      )}
