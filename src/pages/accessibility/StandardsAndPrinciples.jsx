  ...
  return (
    ...
    >
      <section id="a11y-digital" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">What is digital accessibility?</h2>
        ...
        <p className="text-o9ds-light-secondary dark:text-neutral-400">Accessibility is not limited to web pages. It applies across:</p>
      ...
      <section id="a11y-disability" className="space-y-6 scroll-mt-24">
        <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Understanding disability</h2>
        <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed">
        ...
        <figure className="border border-o9ds-light-border dark:border-neutral-700 p-4 md:p-6 bg-o9ds-light-surface dark:bg-neutral-900/40">
          ...
          <figcaption className="mt-4 text-xs text-o9ds-light-secondary dark:text-neutral-500 text-center leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="block mt-2 text-o9ds-light-primary dark:text-neutral-400">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white mb-2">Permanent</h3>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm mb-2">A long-term condition that affects how someone interacts with digital products.</p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Examples: blindness, low vision, Deafness, mobility impairments, cognitive disabilities.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white mb-2">Temporary</h3>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm mb-2">A short-term limitation.</p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Examples: broken arm, eye strain after surgery, temporary hearing loss, fatigue or concussion.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white mb-2">Situational</h3>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm mb-2">A limitation caused by context rather than the person.</p>
            <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Examples: bright sunlight, noisy office, one-handed phone use, weak connection, distraction.</p>
          </div>
        </div>
      </section>

      <section id="a11y-pour" className="space-y-8 scroll-mt-24">
        <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">The POUR principles</h2>
        <p className="text-o9ds-light-secondary dark:text-neutral-400">The four foundational accessibility principles are:</p>
        <figure className="border border-o9ds-light-border dark:border-neutral-700 p-4 md:p-6 bg-o9ds-light-surface dark:bg-neutral-900/40">
          <ExpandableDocImage
        ...
        <div className="space-y-4 border border-o9ds-light-border dark:border-neutral-700 p-6">
          <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">Perceivable</h3>
          <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Users must be able to perceive the content.</p>
          ...
          <p className="text-sm text-o9ds-light-secondary dark:text-neutral-400">
            <strong className="text-o9ds-light-primary dark:text-white">Example:</strong> A chart shown only as colored shapes is not perceivable enough. Add labels, patterns, or a data table.
          </p>
        </div>

        <div className="space-y-4 border border-o9ds-light-border dark:border-neutral-700 p-6">
          <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">Operable</h3>
          <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Users must be able to operate the interface.</p>
          <ul className="list-disc list-inside space-y-1 text-sm text-o9ds-light-secondary dark:text-neutral-400">
          ...
          <p className="text-sm text-o9ds-light-secondary dark:text-neutral-400">
            <strong className="text-o9ds-light-primary dark:text-white">Example:</strong> A dropdown that opens only on hover is not operable for keyboard users.
          </p>
        </div>

        <div className="space-y-4 border border-o9ds-light-border dark:border-neutral-700 p-6">
          <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">Understandable</h3>
          <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Users must be able to understand the content and interaction model.</p>
          <ul className="list-disc list-inside space-y-1 text-sm text-o9ds-light-secondary dark:text-neutral-400">
          ...
          <p className="text-sm text-o9ds-light-secondary dark:text-neutral-400">
            <strong className="text-o9ds-light-primary dark:text-white">Example:</strong> “Invalid input” is too vague. “Enter a valid email address” is understandable.
          </p>
        </div>

        <div className="space-y-4 border border-o9ds-light-border dark:border-neutral-700 p-6">
          <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">Robust</h3>
          <p className="text-o9ds-light-secondary dark:text-neutral-400 text-sm">Content must work with current and future browsers and assistive technologies.</p>
          <ul className="list-disc list-inside space-y-1 text-sm text-o9ds-light-secondary dark:text-neutral-400">
            <li>semantic HTML</li>
          ...
          <p className="text-sm text-o9ds-light-secondary dark:text-neutral-400">
            <strong className="text-o9ds-light-primary dark:text-white">Example:</strong> A button built with a <code className="px-1" data-o9ds-inline-code>div</code> may look correct visually, but without role and keyboard support it is not robust.
          </p>
        </div>
      </section>

      <section id="a11y-wcag" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">WCAG</h2>
        <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed">
          WCAG stands for <strong className="text-o9ds-light-primary dark:text-white">Web Content Accessibility Guidelines</strong>. It is the most widely used global standard for digital accessibility.
        </p>
        <figure className="border border-o9ds-light-border dark:border-neutral-700 p-4 md:p-6 bg-o9ds-light-surface dark:bg-neutral-900/40">
          <ExpandableDocImage
          ...
          />
          <figcaption className="mt-4 text-xs text-o9ds-light-secondary dark:text-neutral-500 text-center leading-relaxed max-w-3xl mx-auto">
            WCAG has evolved from 1.0 through 2.2; o9 aligns product and design system work to <strong className="text-o9ds-light-primary dark:text-white">WCAG 2.2 AA</strong>.
          </figcaption>
        </figure>
        <h3 className="text-lg font-semibold text-o9ds-light-primary dark:text-white">Conformance levels</h3>
        <ul className="list-disc list-inside space-y-2 text-o9ds-light-secondary dark:text-neutral-400">
          <li>
            <strong className="text-o9ds-light-primary dark:text-white">Level A</strong> — Minimum accessibility support.
          </li>
          <li>
            <strong className="text-o9ds-light-primary dark:text-white">Level AA</strong> — The standard baseline for most production digital products.
          </li>
          <li>
            <strong className="text-o9ds-light-primary dark:text-white">Level AAA</strong> — Highest level; usually not practical to meet everywhere.
          </li>
        </ul>
      </section>
      ...
      <section id="a11y-baseline" className="space-y-4 scroll-mt-24">
        ...
        <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed">
          We follow <strong className="text-o9ds-light-primary dark:text-white">WCAG 2.2 AA</strong>.
        </p>
        <p className="text-o9ds-light-secondary dark:text-neutral-400">That means our design system components and patterns should support:</p>
        <ul className="list-disc list-inside space-y-2 text-o9ds-light-secondary dark:text-neutral-400">
      ...
      <section id="a11y-ds" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-o9ds-light-primary dark:text-white">Design system implication</h2>
        <p className="text-o9ds-light-secondary dark:text-neutral-400 leading-relaxed">
