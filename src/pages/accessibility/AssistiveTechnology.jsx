  ...
  return (
    ...
    >
      ...
      <section id="a11y-at-common" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Common assistive technologies</h2>
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Screen readers</h3>
            <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm mb-2">Screen readers convert content into speech or braille output.</p>
            <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">Common examples: NVDA (Windows), JAWS (Windows), VoiceOver (macOS, iOS), TalkBack (Android).</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Screen magnifiers</h3>
            <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">Magnifiers enlarge content for users with low vision.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Braille displays</h3>
            <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">Braille displays present digital content through tactile output.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Speech recognition</h3>
            <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">Speech tools allow users to control interfaces with voice commands.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-arvo-light-primary dark:text-white mb-2">Keyboard-only access</h3>
            <p className="text-arvo-light-secondary dark:text-neutral-400 text-sm">Some users rely entirely on a keyboard instead of a mouse.</p>
          </div>
        </div>
      </section>

      <section id="a11y-at-ds" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Why this matters for design systems</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
      ...
      <section id="a11y-at-tree" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Screen readers do not “see” the UI</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
          A screen reader does not understand visual layout the way a designer does. It reads what is exposed through the <strong className="text-arvo-light-primary dark:text-white">accessibility tree</strong>.
        </p>
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
      ...
      <section id="a11y-at-modes" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Browse mode vs focus mode</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
          Screen readers often use two different interaction models. <strong className="text-arvo-light-primary dark:text-white">Browse mode</strong> is used to read and navigate content—users may jump by headings, links, buttons, landmarks, or form fields.{' '}
          <strong className="text-arvo-light-primary dark:text-white">Focus mode</strong> (or forms mode) is used to interact with controls such as inputs, dropdowns, buttons, and custom widgets.
        </p>
        <figure className="border border-arvo-light-border dark:border-neutral-700 p-4 md:p-6 bg-arvo-light-surface dark:bg-neutral-900/40">
          <ExpandableDocImage
      ...
      <section id="a11y-at-expect" className="space-y-4 scroll-mt-24">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">What screen reader users expect</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">
        ...
        <ul className="list-disc list-inside space-y-2 text-arvo-light-secondary dark:text-neutral-400 text-sm">
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Checkbox:</strong> “Email notifications, checkbox, checked”
          </li>
          <li>
            <strong className="text-arvo-light-primary dark:text-white">Tab:</strong> “Overview, tab, selected, 1 of 4”
          </li>
        </ul>
      </section>

      <section id="a11y-at-rule" className="space-y-4 scroll-mt-24 border border-arvo-light-border dark:border-neutral-700 p-6">
        <h2 className="text-xl font-bold text-arvo-light-primary dark:text-white">Good design system rule</h2>
        <p className="text-arvo-light-secondary dark:text-neutral-400 leading-relaxed">For every component, define:</p>
        <ul className="list-disc list-inside space-y-2 text-arvo-light-secondary dark:text-neutral-400">
